...
//sidebar
        ...
        return view('system-mgmt/asset-category/index', ['structures' => $structures,'tree'=>$tree]);
    }
...
//sidebar
        ...
        return view( 'system-mgmt/asset-category/create',['tree'=>$tree]);
    }
...
//sidebar
      ...
      return view( 'system-mgmt/asset-category/index', compact(['structures','blocks','tree']));
    }
...
//sidebar
        ...
        return view( 'system-mgmt/asset-category/edit', ['structure' => $structure,'tree'=>$tree]);
    }
    ...
    {
        $structure = Asset_cat::findOrFail($id);
        $this->validateInput($request);
        $input = [
            'name' => $request['name']
        ];
        Asset_cat::where('id', $id)
            ->update($input);
...
//sidebar
       ...
       return view( 'system-mgmt/asset-category/index', ['structures' => $structures, 'searchingVals' => $constraints,'tree'=>$tree]);
    }

    private function doSearchingQuery($constraints) {
        $query = Asset_cat::query();

...
foreach ( $ChildDivisions as $Division => $get) {
  ...
  return $result2;
    ...
    //sidebar
        ...
        return view('system-mgmt/party/index', ['structures' => $structures,'tree'=>$tree]);
    }
    ...
    public function create()
    {
      ...
      $tree = session()->get('tree');
      //sidebar
           $memgroup = DB::table('member_groups')->get();
        return view('system-mgmt/party/create',['memgroup'=>$memgroup,'tree'=>$tree]);
    }
    ...
    //sidebar
        ...
        $memgroup = DB::table('member_groups')->get();
        return view('system-mgmt/party/edit', ['memgroup' => $memgroup,'structure' => $structure,'tree'=>$tree]);
    }
    ...
    public function search(Request $request) {
      ...
      //sidebar
       ...
       return view('system-mgmt/party/index', ['structures' => $structures, 'searchingVals' => $constraints,'tree'=>$tree]);
    }

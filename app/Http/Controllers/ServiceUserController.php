...
$serv = service_Form::where('group_service_id',$grou)->get();
          ...
          return view('system-mgmt/serviceuser/index',['serv'=>$serv,'group'=>$group,'serg'=>$serg,'curfamss'=>$curfamss,'matchids'=>$matchids,'port'=>$port,'sta'=>$sta,'serviceforms' => $serviceforms,'tree'=>$tree]);
    }
    ...
    //return $port;
                   ...
                   $ans = "<b>".$n."</b>"." <br> "."<b>".$t1."</b>"." <br> ".$a1." ".$u1."<br> "."<b>".$t2."</b>"." <br> ".$a2." ".$u2." <br>"."<b>".$t3."</b>"." <br> ".
                     ...
                     //return $port;
                                 ...
                                 $ans = "<b>".$n."</b>"." <br> "."<b>".$t1."</b>"." <br> ".$a1." ".$u1."<br> "."<b>".$t2."</b>"." <br> ".$a2." ".$u2." <br>"."<b>".$t3."</b>"." <br> ".
                                        $a3." ".$u3."<br> "."<b>".$t4."</b>"." <br> ".$a4." ".$u4."<br> "."<b>".$t5."</b>"." <br> ".$a5." ".$u5 ."<b>".$qt."</b>"." <br> ".$time." "."<br> "
                                        ."<b>".$qti."</b>"." <br> ".$ati." "."<br> "."<b>".$qm."</b>"." <br> ".$more." "."<br> "."<b>".$qp."</b>"." <br> ".$ports." "."<br> ";
                                      }
      $noti = new Noti;
 ...
 $request->session()->flash('alert-success', 'การร้องขอบริการของท่านสำเร็จแล้ว!! โปรดรอพนักงานติดต่อกลับ ');
  ...
  //sidebar
      ...
      $serv = service_Form::where('group_service_id',$grou)->get();
                     return view('system-mgmt/serviceuser/filtergroup', ['group'=>$group,'serv'=>$serv,'serg'=>$serg,'curfamss'=>$curfamss,'matchids'=>$matchids,'port'=>$port,'sta'=>$sta,'serviceforms' => $serviceforms,'tree'=>$tree]);
  ...
  //sidebar
      ...
      ->select('service_form.*','group_of_service.name as group_service_name', 'group_of_service.id as group_service_id'
       ...
       $group = Group_service::where('id',$servi)->get();
                     return view('system-mgmt/serviceuser/filter', ['group'=>$group,'serv'=>$serv,'serg'=>$serg,'curfamss'=>$curfamss,'matchids'=>$matchids,'port'=>$port,'sta'=>$sta,'serviceforms' => $serviceforms,'tree'=>$tree]);
...
//sidebar
     ...
     $serv = service_Form::where('group_service_id',$grou)->get();
             ...
             return view('system-mgmt/serviceuser/showall', ['serv'=>$serv,'group'=>$group,'serg'=>$serg,'curfamss'=>$curfamss,'matchids'=>$matchids,'port'=>$port,'sta'=>$sta,'serviceforms' => $serviceforms,'tree'=>$tree]);
    ...
    public function listgroup(Request $request){
      ...
      ->leftJoin('group_of_service', 'service_form.group_service_id', '=', 'group_of_service.id')
      ->leftJoin('message_types', 'service_form.msg_type_id', '=', 'message_types.id')
      ->where('group_of_service.name' , $org)
      ->select('service_form.*','group_of_service.name as group_service_name', 'group_of_service.id as group_service_id'
                ,'message_types.message_template as msg_type_name', 'message_types.id as msg_type_id')
       ...
       date_default_timezone_set('Asia/Bangkok');
       $d  = date('Y-m-d H:i:s');
                     return view('system-mgmt/serviceper/index', ['serg'=>$serg,'curfamss'=>$curfamss,'matchids'=>$matchids,'port'=>$port,'sta'=>$sta,'serviceforms' => $serviceforms,'tree'=>$tree]);

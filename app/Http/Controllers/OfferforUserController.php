...
class OfferforUserController extends Controller
{
    /**
    ...
    public function create()
    {
      ...
      $publicid = match_id::all();*/
        ...
        return view( 'system-mgmt/offerforuser/create',compact(['branch','userlevel','partnerlevel','otherrate','coorrate','taxrate','memberlevel','campaign','promotion','proposal','member','branch','publicid','offer','offertype']));
    }
    ...
    public function edit($id)
    {
        ...
        $url = $_SERVER['REQUEST_URI'];
        $caseid = explode('?prev/wealththaiinsurance/casesuser/',$url);
    ...
    public function search(Request $request) {
       ...
       return view( 'system-mgmt/offerforuser/index', ['proposal' => $proposal,'member' => $member,'branch' => $branch,'publicid' => $publicid,'offer' => $offer,'offertype' => $offertype,'data' => $data, 'searchingVals' => $constraints]);
    }

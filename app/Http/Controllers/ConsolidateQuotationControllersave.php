...
foreach ($findoffer as $index =>$chunk)
{
  ...
  $html .="<table style='margin-top:160px' class='table'>
    ...
    <tr>
    <td class='table'style='background-color:#dedee3;text-align:left; '>พรบ หน้าตั๋ว</td>
      <td class='table'>{$offeract}</td>
    </tr>
    <tr>
      <td class='table'style='background-color:#dedee3;text-align:left; '>ราคาจ่ายจริง (พรบ/เฉพาะเงินสด)</td>
      <td class='table'>{$resultact}</td>
    </tr>
    <tr>
      <td class='table'style='background-color:#dedee3;text-align:left; '>ราคาชำระค่าภาษี</td>
      <td class='table'>{$resulttax}</td>
    </tr>
    <tr>
      <td class='table'style='background-color:#dedee3;text-align:left; '>เบี้ยที่ต้องชำระรวม</td>
      <td class='table'>{$allresult}</td>
    </tr>
    <tr>
      <td class='table'style='background-color:#dedee3;text-align:left; '>ภาษีหัก ณ ที่จ่าย (รวม)</td>
      <td class='table'>{$allresultpaytax}</td>
    </tr>
    <tr>
      <td class='table'style='background-color:#dedee3;text-align:left; '>ค่าคอมมิชชั่นผู้ให้บริการ(รวม)</td>
    ...
    <tr>
      <td class='table'style='background-color:#dedee3;text-align:left; '>เบี้ยที่ผู้ให้บริการต้องชำระ(รวม)</td>

...
foreach ( $ChildDivisions as $Division => $get) {
  ...
  return $result;
    ...
    public function index()
    {
      ...
      //sidebar
       ...
       ->paginate(20);
        return view('system-mgmt/event/index', ['events' => $events,'tree' => $tree]);
    }
    ...
    //    return $year;
      ...
      $matchid = match_id::whereNotNull('user_id')->get();
        return view('system-mgmt/event/create',['matchid' =>$matchid,'status' =>$status,'groups' =>$groups,'groupmems' =>$groupmems,'day' =>$day,'month' =>$month,'year' =>$year,'time' =>$time,'eventtypes' => $eventtypes, 'organizes' => $organizes,'tree'=>$tree]);
    }
    ...
    public function show($id)
    {
      ...
      $matchid = match_id::whereNotNull('user_id')->get();
        ...
        return view('system-mgmt/event/showmem', ['matchid' => $matchid,'member' => $member,'event' => $event, 'eventtypes' => $eventtypes,'organizes' => $organizes,'tree'=>$tree]);
    }
  ...
  if($curdob != NULL){
    ...
    $cureyear ="";
      ...
      //  return $member;
      $matchid = match_id::whereNotNull('user_id')->get();
        return view('system-mgmt/event/edit', ['matchid' =>$matchid,'curdate' =>$curdate,'curmonth' =>$curmonth,

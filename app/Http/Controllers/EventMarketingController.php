...
foreach ( $ChildDivisions as $Division => $get) {
  ...
  return $result;
    ...
    public function index()
    {
      ...
      //sidebar
       ...
       ->paginate(20);
        return view('system-mgmt/eventmarketing/index', ['events' => $events,'tree' => $tree]);
    }
    ...
    //    return $year;
      ...
      $matchid = match_id::whereNotNull('user_id')->get();
        return view('system-mgmt/eventmarketing/create',['matchid' =>$matchid,'status' =>$status,'groups' =>$groups,'groupmems' =>$groupmems,'day' =>$day,'month' =>$month,'year' =>$year,'time' =>$time,'eventtypes' => $eventtypes, 'organizes' => $organizes,'tree'=>$tree]);
    }
    ...
    public function store(Request $request)
    {
      ...
      //  $this->validateInput($request);
        ...
        $event->ticket_cost = $request -> ticket_cost;
        $event->redirect_link = $request -> redirect_link;
        $event->noti_pid = $request -> noti_pid;
        $event->save();
        return redirect ('/eventmarketing');
    }
    ...
    public function show($id)
    {
      ...
      $matchid = match_id::whereNotNull('user_id')->get();
        ...
        return view('system-mgmt/eventmarketing/showmem', ['matchid' => $matchid,'member' => $member,'event' => $event, 'eventtypes' => $eventtypes,'organizes' => $organizes,'tree'=>$tree]);
    }
  ...
  if($curdob != NULL){
    ...
    $cureyear ="";
      ...
      //  return $member;
      $matchid = match_id::whereNotNull('user_id')->get();
        return view('system-mgmt/eventmarketing/edit', ['matchid' =>$matchid,'curdate' =>$curdate,'curmonth' =>$curmonth,
    ...
    //  $constraints['structure_name'] = $request['structure_name'];
       ...
       return view('system-mgmt/eventmarketing/index', ['events' => $events, 'searchingVals' => $constraints,'tree'=>$tree]);
    }
    ...
    public function mem($id)
    {
      ...
      //sidebar
        ...
        $member = DB::table('persons')->where('event_id',1)->get();
      //  return $member;
        return view('system-mgmt/eventmarketing/showmem', ['member' => $member,'event' => $event, 'eventtypes' => $eventtypes,'organizes' => $organizes,'tree'=>$tree]);
    }
    public function showevent($id){
     ...
     ->get();
      ...
      return view('system-mgmt/eventmarketing/showevent', compact(['ref','tree']));
    }

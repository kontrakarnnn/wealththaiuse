...
class ToolOrderUserController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        $data = Tool_Order::with(['Person','ToolSet','ToolPackage','Tool_Order_Status'])->paginate(30);
        return view('system-mgmt/check-order/index', ['data' => $data,'member' => $member,'toolset' => $toolset,'toolpackage' => $toolpackage,'toolorderstatus' => $toolorderstatus]);
    }
    /**
    ...
    public function create()
    {
      ...
      if ( strstr($url, '?') ) {
        ...
        return view( 'system-mgmt/check-order/create', ['portfolio' => $portfolio,'tool' => $tool,'tool' => $tool,'member' => $member,'toolset' => $toolset,'toolpackage' => $toolpackage,'toolorderstatus' => $toolorderstatus]);
    }
     ...
     */
     public function changeorderstatus(Request $request){
       ...
       $url = $_SERVER['REQUEST_URI'];
       $url = explode('/',$url);
       $status = Tool_Order::find($url[2]);
       $status->order_status = $url[3];
  ...
  /*  public function update(Request $request, $id)
    ...
    public function search(Request $request) {
       ...
       return view( 'system-mgmt/check-order/index', ['data' => $data, 'searchingVals' => $constraints,'member' => $member,'toolset' => $toolset,'toolpackage' => $toolpackage,'toolorderstatus' => $toolorderstatus]);
    }
    ...
    private function validateInput($request) {
        $this->validate($request, [
          //  'invoice_number' => 'unique:tool_order',
    ]);
    }
}

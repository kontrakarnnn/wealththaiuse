...
class LeadAdminController extends Controller
{
    ...
    public function index()
    {
      ...
      //  return $date;
        ...
        $lead = DB::table('persons')->where('type','!=',1)
        ->where('lead_status','!=',4)
        ...
        ->paginate(30);
        $recontact = DB::table('persons')->where('type','!=',1)
        ->where('lead_status','!=',4)
        ...
        ->get();
        //return $recontact;
        $recontactcount = DB::table('persons')->where('type','!=',1)
        ->where('lead_status','!=',4)
        ->whereIn('re_contact_date', [$date1,$date2])
        ->leftjoin('lead_status','persons.lead_status','=','lead_status.id')
        ->select('persons.*','lead_status.name as lead_statusname')
        ...
        $recontactearly = DB::table('persons')->where('type','!=',1)
        ->where('lead_status','!=',4)
        ->leftjoin('lead_status','persons.lead_status','=','lead_status.id')
        ->select('persons.*','lead_status.name as lead_statusname')
        ->orderBy('persons.regis_date', 'DESC')
        ...
        $recontactearlycount = DB::table('persons')->where('type','!=',1)
        ->where('lead_status','!=',4)
        ...
        $recontactcurrent = DB::table('persons')->where('type','!=',1)
        ->where('lead_status','!=',4)
        ->where('re_contact_date','=',$currentdate)
        ->leftjoin('lead_status','persons.lead_status','=','lead_status.id')
        ->select('persons.*','lead_status.name as lead_statusname')
        ...
        $recontactcurrentcount = DB::table('persons')->where('type','!=',1)
        ->where('lead_status','!=',4)
        ->where('re_contact_date','=',$currentdate)
        ->leftjoin('lead_status','persons.lead_status','=','lead_status.id')
        ->select('persons.*','lead_status.name as lead_statusname')
        ...
        $meetingdatenear = DB::table('persons')->where('type','!=',1)
        ->where('lead_status','!=',4)
        ...
        ///->orderBy('persons.priority', 'DESC')
        ->get();
        $meetingdatecurrent = DB::table('persons')->where('type','!=',1)
        ->where('lead_status','!=',4)
        ...
        ///->orderBy('persons.priority', 'DESC')
        ->get();
        $meetingdatecurrentcount = DB::table('persons')->where('type','!=',1)
        ->where('lead_status','!=',4)
        ->where('meeting_date','=',$currentdate)
        ->leftjoin('lead_status','persons.lead_status','=','lead_status.id')
        ->select('persons.*','lead_status.name as lead_statusname')
        ...
        ///->orderBy('persons.priority', 'DESC')
        ->count();
        $meetingdateearly = DB::table('persons')->where('type','!=',1)
        ->where('lead_status','!=',4)
        ->leftjoin('lead_status','persons.lead_status','=','lead_status.id')
        ->select('persons.*','lead_status.name as lead_statusname')
        ->orderBy('persons.regis_date', 'DESC')
        ///->orderBy('persons.priority', 'DESC')
        ->get();
        $meetingdateearlycount = DB::table('persons')->where('type','!=',1)
        ->where('lead_status','!=',4)
        ->where('meeting_date','<',$currentdate)
        ->leftjoin('lead_status','persons.lead_status','=','lead_status.id')
        ->select('persons.*','lead_status.name as lead_statusname')
        ...
        ->count();
        //return $lead;
        $leadcount = DB::table('persons')->where('type','!=',1)
        ->where('lead_status','!=',4)
        ->leftjoin('lead_status','persons.lead_status','=','lead_status.id')
        ->select('persons.*','lead_status.name as lead_statusname')
        ->orderBy('persons.regis_date', 'DESC')
    ...
    public function changestatus(Request $request){
      ...
      return redirect('/admin/leadadmin');
    }
     ...
     */
     ...
     public function show($id)
     {
       $current = Auth::user()->id;
       $current_pid = DB::table('match_id')->where('user_id',$current)->value('id');
       $lead = DB::table('persons')->where('ref_user_pid',$current_pid)->where('type','!=',1)
       ->get();
         return view('system-mgmt/leadadmin/show',compact(['lead']));
     }

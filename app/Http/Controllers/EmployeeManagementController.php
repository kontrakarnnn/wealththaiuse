...
class EmployeeManagementController extends Controller
{
    ...
    public function index()
    {
        ...
        ->leftJoin('structure', 'employees.structure_id', '=', 'structure.id')
        ->leftJoin('state', 'employees.state_id', '=', 'state.id')
        ->leftJoin('country', 'employees.country_id', '=', 'country.id')
        ->leftJoin('block', 'employees.block_id', '=', 'block.id')
        ->select('employees.*', 'structure.name as structure_name', 'structure.id as structure_id', 'block.name as block_name', 'block.id as block_id')
        ->paginate(5);
    ...
    private function doSearchingQuery($constraints) {
        ...
        ->leftJoin('country', 'employees.country_id', '=', 'country.id')
        ->leftJoin('block', 'employees.block_id', '=', 'block.id')
        ->select('employees.firstname as employee_name', 'employees.*','structure.name as structure_name', 'structure.id as structure_id', 'block.name as block_name', 'block.id as block_id');

    ...
    public function __construct()
    {
     ...
     public function quotation($id)
      ...
      if(!in_array($id,$casecansee))
      {
        ...
        $findasset = Asset::with(['assettype'])->find($findcase->referal_asset);
...
header { position: fixed;
 ...
 <table style='margin-top:-20px' class='table'>
   <tr>
     <td width:10% class='table'style='background-color:#dedee3;text-align:left;'>{$findasset->assettype->ref_info_head7}</td>
     <td  class='table'style='background-color:#dedee3'>{$findasset->assettype->ref_info_head3}</td>
     <td class='table' style='background-color:#dedee3'>{$findasset->assettype->ref_info_head4}</td>
     <td  class='table'style='background-color:#dedee3;'>{$findasset->assettype->ref_name_head}</td>
     <td  class='table'style='background-color:#dedee3'>{$findasset->assettype->ref_info_head5}</td>
     <td class='table'style='background-color:#dedee3;text-align:left;'>{$findasset->assettype->ref_info_head6}</td>
     <td  class='table' style='background-color:#dedee3'>{$findasset->assettype->ref_info_head13}</td>
   </tr>
   <tr>
...
foreach ($findoffer as $index =>$chunk)
{
  ...
  $html .="<table style='margin-top:175px' class='table'>
    ...
    foreach($chunk as $findof)
    {
      ...
      foreach($chunk as $findof)
      {
      $html .="<tr><td class='table'style='background-color:#dedee3;text-align:left; '>{$findof->OfferType->offer_value_name1}</td>";
      break;
      }
      foreach($chunk as $findof)
      {
      ...
      foreach($chunk as $findof)
      {
      $html .="<tr><td class='table'style='background-color:#dedee3;text-align:left; '>{$findof->OfferType->offer_value_name2}</td>";
      break;
      }
      foreach($chunk as $findof)
      {
      ...
      foreach($chunk as $findof)
      {
      $html .="<tr><td class='table'style='background-color:#dedee3;text-align:left; '>{$findof->OfferType->offer_value_name3}</td>";
      break;
      }
      foreach($chunk as $findof)
      {
      ...
      foreach($chunk as $findof)
      {
      $html .="<tr><td class='table'style='background-color:#dedee3;text-align:left; '>{$findof->OfferType->offer_value_name4}</td>";
      break;
      }
      foreach($chunk as $findof)
      {
      ...
      foreach($chunk as $findof)
      {
      $html .="<tr><td class='table'style='background-color:#dedee3;text-align:left; '>{$findof->OfferType->offer_value_name5}</td>";
      break;
      }
      foreach($chunk as $findof)
      {
        $html .= "<td class='table'>{$findof->offer_value5}</td>";
      }
      $html .="</tr>";
      foreach($chunk as $findof)
      {
      $html .="<tr><td class='table'style='background-color:#dedee3;text-align:left; '>{$findof->OfferType->offer_value_name7}</td>";
      break;
      }
      foreach($chunk as $findof)
      {
      ...
      foreach($chunk as $findof)
      {
      $html .="<tr><td class='table'style='background-color:#dedee3;text-align:left; '>{$findof->OfferType->offer_value_name14}</td>";
      break;
      }
      foreach($chunk as $findof)
      {
      ...
      foreach($chunk as $findof)
      {
      $html .="<tr><td class='table'style='background-color:#dedee3;text-align:left; '>{$findof->OfferType->offer_value_name19}</td>";
      break;
      }
      foreach($chunk as $findof)
      {
      ...
      foreach($chunk as $findof)
      {
      $html .="<tr><td class='table'style='background-color:#dedee3;text-align:left; '>{$findof->OfferType->offer_value_name8}</td>";
      break;
      }
      foreach($chunk as $findof)
      {
      ...
      foreach($chunk as $findof)
      {
      $html .="<tr><td class='table'style='background-color:#dedee3;text-align:left; '>{$findof->OfferType->offer_value_name12}</td>";
      break;
      }
      foreach($chunk as $findof)
      {
      ...
      foreach($chunk as $findof)
      {
      $html .="<tr><td class='table'style='background-color:#dedee3;text-align:left; '>{$findof->OfferType->offer_value_name13}</td>";
      break;
      }
      foreach($chunk as $findof)
      {
      ...
      foreach($chunk as $findof)
      {
      $html .="<tr><td class='table'style='background-color:#dedee3;text-align:left; '>{$findof->OfferType->offer_payment_name1}</td>";
      break;
      }
      foreach($chunk as $findof)
      {
      ...
      foreach($chunk as $findof)
      {
      $html .="<tr><td class='table'style='background-color:#dedee3;text-align:left; '>{$findof->OfferType->offer_payment_name2}</td>";
      break;
      }      foreach($chunk as $findof)
      {
      ...
      foreach($chunk as $findof)
      {
      $html .="<tr><td class='table'style='background-color:#dedee3;text-align:left; '>{$findof->OfferType->offer_payment_name3}</td>";
      break;
      }
      foreach($chunk as $findof)
      {
      ...
      foreach($chunk as $findof)
      {
      $html .="<tr><td class='table'style='background-color:#dedee3;text-align:left; '>{$findof->OfferType->offer_payment_name4}</td>";
      break;
      }
      foreach($chunk as $findof)
      {
      ...
      foreach($chunk as $findof)
      {
      $html .="<tr><td class='table'style='background-color:#dedee3;text-align:left; '>{$findof->OfferType->offer_payment_name15}</td>";
      break;
      }
      foreach($chunk as $findof)
      {
      ...
      foreach($chunk as $findof)
      {
      $html .="<tr><td class='table'style='background-color:#dedee3;text-align:left; '>{$findof->OfferType->offer_value_name18}</td>";
      break;
      }
      foreach($chunk as $findof)
      {
      ...
      foreach($chunk as $findof)
      {
      $html .="<tr><td class='table'style='background-color:#dedee3;text-align:left; '>{$findof->OfferType->offer_payment_name19}</td>";
      break;
      }
      foreach($chunk as $findof)
      {
...
<table style='margin-top:175px' class='table'>
    ...
    foreach($chunk as $findof)
    {
      ...
      <tr>
        ...
        <tr>
            <td class='table'style='background-color:#dedee3;text-align:left; '>{$findof->OfferType->offer_value_name1}</td>
            <td class='table'>{$findof->offer_value1}</td>
        </tr>
        <tr>
            <td class='table'style='background-color:#dedee3;text-align:left; '>{$findof->OfferType->offer_value_name2}</td>
            <td class='table'>{$findof->offer_value2}</td>
        </tr>
        <tr>
            <td class='table'style='background-color:#dedee3;text-align:left; '>{$findof->OfferType->offer_value_name3}</td>
            <td class='table'>{$findof->offer_value3}</td>
        </tr>
        <tr>
            <td class='table'style='background-color:#dedee3;text-align:left; '>{$findof->OfferType->offer_value_name4}</td>
        ...
        <tr>
            <td class='table'style='background-color:#dedee3;text-align:left; '>{$findof->OfferType->offer_value_name5}</td>
            <td class='table'>{$findof->offer_value5}</td>
        </tr>
        <tr>
            <td class='table'style='background-color:#dedee3;text-align:left; '>{$findof->OfferType->offer_value_name7}</td>
            <td class='table'>{$findof->offer_value7}</td>
        </tr>
        <tr>
            <td class='table'style='background-color:#dedee3;text-align:left; '>{$findof->OfferType->offer_value_name14}</td>
        ...
        <tr>
            <td class='table'style='background-color:#dedee3;text-align:left; '>{$findof->OfferType->offer_value_name19}</td>
            <td class='table'>{$findof->offer_value19}</td>
        </tr>
        <tr>
            <td class='table'style='background-color:#dedee3;text-align:left; '>{$findof->OfferType->offer_value_name8}</td>
            <td class='table'>{$findof->offer_value8}</td>
        </tr>
        <tr>
            <td class='table'style='background-color:#dedee3;text-align:left; '>{$findof->OfferType->offer_value_name12}</td>
            <td class='table'>{$findof->offer_value12}</td>
        </tr>
        <tr>
            <td class='table'style='background-color:#dedee3;text-align:left; '>{$findof->OfferType->offer_value_name13}</td>
        ...
        <tr>
            <td class='table'style='background-color:#dedee3;text-align:left; '>{$findof->OfferType->offer_payment_name1}</td>
            <td class='table'>{$findof->offer_payment_value1}</td>
        </tr>
        <tr>
            <td class='table'style='background-color:#dedee3;text-align:left; '>{$findof->OfferType->offer_payment_name2}</td>
            <td class='table'>{$findof->offer_payment_value2}</td>
        </tr>
        <tr>
            <td class='table'style='background-color:#dedee3;text-align:left; '>{$findof->OfferType->offer_payment_name3}</td>
            <td class='table'>{$findof->offer_payment_value3}</td>
        </tr>
        <tr>
            <td class='table'style='background-color:#dedee3;text-align:left; '>{$findof->OfferType->offer_payment_name4}</td>
            <td class='table'>{$findof->offer_payment_value4}</td>
        </tr>
        <tr>
            <td class='table'style='background-color:#dedee3;text-align:left; '>{$findof->OfferType->offer_payment_name15}</td>
        ...
        <tr>
            <td class='table'style='background-color:#dedee3;text-align:left; '>{$findof->OfferType->offer_value_name18}</td>
            <td class='table'>{$findof->offer_value18}</td>
        </tr>
        <tr>
            <td class='table'style='background-color:#dedee3;text-align:left; '>{$findof->OfferType->offer_payment_name5}</td>
            <td class='table'>{$findof->offer_payment_value5}</td>
        </tr>
        <tr>
            <td class='table'style='background-color:#dedee3;text-align:left; '>{$findof->OfferType->offer_payment_name19}</td>
...
foreach($findoffertax as $chunk)
{
      ...
      foreach($chunk as $findof)
      {
        ...
        <tr>
          <td  class='table'style='background-color:#dedee3;text-align:left;width:50% '>{$findof->OfferType->offer_payment_name1}</td>
          <td class='table'>{$findof->offer_payment_value1}</td>
        </tr>
        <tr>
          <td  class='table'style='background-color:#dedee3;text-align:left;width:50% '>{$findof->OfferType->offer_payment_name2}</td>
          <td class='table'>{$findof->offer_payment_value2}</td>
        </tr>
        <tr>
          <td  class='table'style='background-color:#dedee3;text-align:left;width:50% '>{$findof->OfferType->offer_payment_name3}</td>
          <td class='table'>{$findof->offer_payment_value3}</td>
        </tr>
        <tr>
          <td  class='table'style='background-color:#dedee3;text-align:left;width:50% '>{$findof->OfferType->offer_payment_name4}</td>
          <td class='table'>{$findof->offer_payment_value4}</td>
        </tr>
        <tr>
          <td  class='table'style='background-color:#dedee3;text-align:left;width:50% '>{$findof->OfferType->offer_payment_name15}</td>
          <td class='table'>{$findof->offer_payment_value15}</td>
        </tr>
        <tr>
        ...
        <tr>
          <td  class='table'style='background-color:#dedee3;text-align:left;width:50% '>{$findof->OfferType->offer_value_name18}</td>
          <td class='table'>{$findof->offer_value18}</td>
        </tr>
        <tr>
          <td  class='table'style='background-color:#dedee3;text-align:left;width:50% '>{$findof->OfferType->offer_payment_name5}</td>
          <td class='table'>{$findof->offer_payment_value5}</td>
        </tr>
        <tr>
          <td  class='table'style='background-color:#dedee3;text-align:left;width:50% '>{$findof->OfferType->offer_payment_name19}</td>
          <td class='table'>{$findof->offer_payment_value19}</td>
        </tr>
        <tr>

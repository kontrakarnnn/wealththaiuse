...
class ProspectCoorController extends Controller
{
    /**
    ...
    public function create()
    {
      ...
      $currentyear = date('Y') + 543;
        return view('system-mgmt/prospectcoor/create',compact(['ref','province','currentyear']));
    }

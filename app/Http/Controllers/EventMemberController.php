...
class EventMemberController extends Controller
{
    ...
    {
        $this->middleware('viewper')->except(["findBlockName"]);
    }
    ...
    public function index()
    {
      ...
      //sidebar
       ...
       ->select('event.*', 'event_type.name as event_type_name', 'event_type.id as event_type_id', 'organize.name as organize_name', 'organize.id as organize_id'
        ...
        return view('system-mgmt/eventmember/index', ['events' => $events,'tree' => $tree]);
    }
    ...
    //    return $year;
      $status = DB::table('event_regis_status')->get();
        return view('system-mgmt/eventmember/create',['status' =>$status,'groups' =>$groups,'groupmems' =>$groupmems,'day' =>$day,'month' =>$month,'year' =>$year,'time' =>$time,'eventtypes' => $eventtypes, 'organizes' => $organizes,'tree'=>$tree]);
    }
  ...
  if($curdob != NULL){
    ...
    $cureyear ="";
        ...
        $status = DB::table('event_regis_status')->get();
      //  return $member;
        return view('system-mgmt/eventmember/edit', ['curdate' =>$curdate,'curmonth' =>$curmonth,
    ...
    //  $constraints['structure_name'] = $request['structure_name'];
       ...
       return view('system-mgmt/eventmember/index', ['events' => $events, 'searchingVals' => $constraints,'tree'=>$tree]);
    }

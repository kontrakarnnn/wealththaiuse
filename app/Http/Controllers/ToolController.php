...
class ToolController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('system-mgmt//tool/index', ['toolcat' => $toolcat,'tooltype' => $tooltype,'data' => $data]);
    }
    /**
    ...
    public function create()
    {
      ...
      $toolstatus = ToolStatus::get();
        ...
        $tooltype = ToolType::with(['ToolCategory'])->get();
        return view( 'system-mgmt/tool/create',compact('toolstatus','tooltype','toolpromotecount'));
    }
    ...
    public function edit($id)
    {
      ...
      $data = Tool::find($id);
        ...
        return view( 'system-mgmt//tool/edit', ['toolstatus' => $toolstatus,'toolpromotecount' => $toolpromotecount,'tooltype' => $tooltype,'data' => $data]);
    }

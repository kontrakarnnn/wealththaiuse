...
class MatchmemberIdController extends Controller
{
    /**
...
foreach ( $ChildDivisions as $Division => $get) {
  ...
  //sidebar
    ...
    return view('system-mgmt/match-member-group/index', ['matchgroups' => $matchgroups,'tree'=>$tree]);
    }
 ...
 //sidebar
       ...
       $ugroups = member_group::all();

       $members = Person::all();
       $matchgroups = match_member_id::all();
       $party = DB::table('party')->get();
        return view('system-mgmt/match-member-group/create', [ 'party' => $party,'ugroups' => $ugroups, 'members' => $members, 'matchgroupss' => $matchgroups,'tree'=>$tree]);
     ...
     public function store(Request $request)
     {
      ...
      'description' => 'nullable|string|max:60'
        ...
        match_member_id::create([
         ...
         return redirect ('/admin/match-member-group');
     }
     ...
     public function edit($id)
     {
       ...
       //sidebar
         ...
         if ($matchgroup == null) {
           ...
           $members = Person::all();
           $party = DB::table('party')->get();
         return view('system-mgmt/match-member-group/edit', ['party' => $party,'matchgroup' => $matchgroup,'ugroups' => $ugroups,'members' => $members,'tree'=>$tree]);
     }
 ...
 //sidebar
        ...
        return view('system-mgmt/match-member-group/index', ['matchgroups' => $matchgroups, 'searchingVals' => $constraints,'tree'=>$tree]);
     }

...
invoicebutton()
{
  ...
  else
  {
    ...
    render() {
      return (
        <div>
        <a style={{float:'left',fontSize:'16px',color:'',padding:'10px'}} className="btn btn-primary btn-margin" href="/wealththaiinsurance/all/cases" >กลับไปหน้าแรก</a>&nbsp;&nbsp;&nbsp;
        <a style={{float:'left',fontSize:'16px',color:'',padding:'10px'}} className="btn btn-warning btn-margin" href="/wealththaiinsurance/all/searchcase" >กลับไปหน้าค้นหา</a>

...
export default class CasePaymentuser extends Component {
...
if (document.getElementById('casepaymentuser')) {
  const component = document.getElementById('casepaymentuser');
  const props = Object.assign({}, component.dataset);
    ReactDOM.render(<CasePaymentuser {...props}/>, component);
}

...
export default class InsuranceStep2user extends Component {
...
if (document.getElementById('insurance2user')) {
    ReactDOM.render(<InsuranceStep2user />, document.getElementById('insurance2user'));
}

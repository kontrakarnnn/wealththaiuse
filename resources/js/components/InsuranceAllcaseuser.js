...
export default class InsuranceAllcaseuser extends Component {
  ...
  rowclick(rowInfo){
    ...
    window.open('/wealththaiinsurance/cases/'+rowInfo.row.id+'/detail/showuser','_self');
  }
    ...
    render() {
      ...
      return (
            ...
            <div>   <a style={{fontSize:'16px'}}href="/wealththaiinsurance/all/case/stageuser" className="btn btn-primary btn-margin">กลับไปหน้าหลัก</a>  <a style={{fontSize:'16px'}} className="btn btn-warning btn-margin" href="/wealththaiinsurance/all/searchcaseuser" >ไปหน้าค้นหาข้อมูล</a><br/><br/>
...
if (document.getElementById('insuranceallcaseuser')) {
    ReactDOM.render(<InsuranceAllcaseuser />, document.getElementById('insuranceallcaseuser'));
}

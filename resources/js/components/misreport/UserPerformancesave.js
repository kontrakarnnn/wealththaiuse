...
export default class UserPerformance extends Component {
  ...
  showfromdatetodate()
  {
    if(this.state.typeofdate == 7)
    {
      return <div><div class="column4">
      <div class="card">
  ...
  this.setState({typeofdate:e.target.value})
  }
  tablerow()
  {
  ...
  tableshow()
  {
    ...
    render() {
      ...
      const data = [
            {
                color: "steelblue",
                points: [{x: date, y: 2}, {x: date, y: 5}, {x: date, y: -3}],
            },
            {
                color: "red",
                points: [{x: 1, y: 10}, {x: 3, y: 3}, {x: 7, y: 10}]
            }
        ];
      return (
            <div>
            ...
            <div class="card-body">
              <select class="form-control" onChange={this.changetypedate}>

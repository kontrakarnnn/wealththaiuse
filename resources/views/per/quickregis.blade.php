        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('per.store') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="name" class="form-control" name="name" value="{{$name}}" >
                        ...
                        <div class="form-group{{ $errors->has('lname') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="lname" type="lname" class="form-control" name="lname" value="{{$lname}}"  >
                        ...
                        <div class="form-group{{ $errors->has('Eng_name') ? ' has-error' : '' }}">
                            <label for="Eng_name" class="col-md-4 control-label">English Name</label>

                            <div class="col-md-6">
                                <input id="Eng_name" type="text" class="form-control" name="Eng_name" value="{{ old('Eng_name') }}" >
                        ...
                        <div class="form-group{{ $errors->has('Eng_lastname') ? ' has-error' : '' }}">
                            <label for="Eng_lastname" class="col-md-4 control-label">Englisg Lastname</label>

                            <div class="col-md-6">
                                <input id="Eng_lastname" type="text" class="form-control" name="Eng_lastname" value="{{ old('Eng_lastname') }}"  >

                                @if ($errors->has('Eng_lastname'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('Eng_lastname') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
                        <div class="form-group{{ $errors->has('nickname') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="nickname" type="nickname" class="form-control" name="nickname" value="{{$nickname}}"  >
                        ...
                        <div class="form-group{{ $errors->has('mobile') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="mobile" type="mobile" class="form-control" name="mobile" value="{{$mobile}}"  >
                        ...
                        <div class="form-group">
                                      ...
                                      <div class="col-md-6">
                                        <input type="checkbox"  name="refered" value="1" checked> Refered To Me<br>
                                          </div>
                                          </div>
                        ...
                        <div class="form-group">
                                        ...
                                        <label class="col-md-4 control-label"></label>
                                      <div class="col-md-6">
                                        <input type="checkbox"  name="refered" value="1"> Refered To Me<br>
                                          </div>
                                          </div>

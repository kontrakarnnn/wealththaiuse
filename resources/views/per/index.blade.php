      ...
      <div class="row">
        <div class="col-sm-12">
          ...
          <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
            <thead>
              <tr role="row">
                <th width="12%" class="sorting_asc" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Name: activate to sort column descending" aria-sort="ascending">Nick Name</th>
                <th width="12%" class="sorting_asc" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Name: activate to sort column descending" aria-sort="ascending">Name</th>
                <th width="12%" class=" " tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Email: activate to sort column ascending">Last Name</th>
                   <th width="12%" class="sorting_asc" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Name: activate to sort column descending" aria-sort="ascending">Name</th>
                <th width="12%" class=" " tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Email: activate to sort column ascending">Last Name</th>
                <th width="12%" class=" " tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Email: activate to sort column ascending">Type</th>
                <th width="12%" class=" " tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Email: activate to sort column ascending">Status</th>
          ...
          <td style ="background-color:#DAF7A6  ;color:black">{{ $user->status }}</td>
                  ...
                  <td style ="background-color:#DAF7A6  ;color:black">
                    <form class="row" method="POST" action="{{ route('per.destroy', ['id' => $user->id]) }}" onsubmit = "return confirm('Are you sure?')">
                        ...
                        <a href="{{ route('per.show', ['id' => $user->id]) }}" class="btn btn-warning   btn-margin">
                        View
                        </a>
                        <a href="{{ route('per.edit', ['id' => $user->id]) }}" class="btn btn-warning   btn-margin">
                        Update
                        </a>
                        <a href="{{ URL::to('/SecurityBroke/per/tool',$user->id)}}" class="btn btn-info   btn-margin">
                                        Product
                                      </a>
						<a href="{{ URL::to('/SecurityBroke/membernote',$user->id)}}" class="btn btn-info   btn-margin">
                            Note
                          </a>
 <a href="https://erp.wealththai.net/SecurityBroke/portfolio?{{$user->id}}" class="btn btn-info   btn-margin">
                                    Portfolio
                                  </a>

    ...
    <section class="content">
          ...
          <section>
              ...
              <div class="wizard">
                  ...
                  @if(isset($per))
            {{Form::open(['method' => 'put', 'route' => ['peradmin.update',$per->id]])}}
          @else
            {{Form::open(['url'=>'per']) }}
          @endif
            ...
            @endif
                      ...
                      <div class="tab-content">
                          ...
                          <div class="tab-pane active" role="tabpanel" id="step1">
                            ...
                            <div class="column">
                        <p><input value="{{ $per->event_id}}"class="form-control"placeholder="Referral Event ID..."   name="event_id"></p>
                          </div>
                              </div>
                              <div class="row">
                                  <div class="column">
                              <p><input value="{{ $per->ref_user_pid}}"class="form-control"placeholder="Refferal user PID..."   name="ref_user_pid"></p>
                                </div>
                                <div class="column">
                              <p><input value="{{ $per->ref_member_pid }}"class="form-control"placeholder="Referral member PID..."   name="ref_member_pid"></p>
                                </div>
								                    <div class="column">
                                  <select class=" form-control department" name="type">

                                      <option value="0" >-Select-</option>
                                      @foreach ($memtypes as $structur)
                                          <option value="{{$structur->id}}"{{$structur->id == $per->type ? 'selected' : ''}}>{{$structur->name}}</option>
                                      @endforeach

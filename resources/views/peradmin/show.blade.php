...
<section class="content">
  <div class="box">
	...
	<div class="col-sm-4">
          <a class="btn btn-warning" href="/admin/peradmin/{{$per->id}}/edit">Edit Data</a>
        </div>
      </div>
    </div>
...
<br />
  ...
  <div style="overflow-x:auto;">
    <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
      <thead>
        <tr role="row">
          <th  class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Email: activate to sort column ascending">Emergency Name</th>
          <th  class="sorting_asc" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Name: activate to sort column descending" aria-sort="ascending">Emergency Phone</th>
          <th  class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Email: activate to sort column ascending">Emergency Email</th>
      ...
      <tbody>
          ...
          <tr role="row" class="odd">
            <td>{{ $per->emergency_name}}</td>
            <td>{{ $per->emergency_phone}}</td>
            <td>{{ $per->emergency_email}}</td>
    ...
    <br>
          ...
          <thead class ="thead-dark">
                  <tr>
                    <th> No. </th>
                    <th ><a class ="btn btn-info" href="{{ URL::to('SecurityBroke/member/uploadfile',[$memid,'xxx','CG3CG',$filerefname])}}">Add File</a></th>
          ...
          <tbody>
              ...
              <tr>
              <td> File{{++$key}}</td>
              <td >  <a style="font-size:16px" href="{{ URL::to('SecurityBroke/showfile',[$a->id])}}" >{{$a->file_public_name}}</a>

                <br />
                <form  role="form" method="POST" action="{{ URL::to('SecurityBroke/file/fakedelete',[$a->id,$memid,'xxx'])}}" onsubmit = "return confirm('Are you sure?')">

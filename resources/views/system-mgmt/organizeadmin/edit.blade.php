    ...
    <div class="row">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                  <form class="form-horizontal" role="form" method="POST" action="{{ route('organizeadmin.update', ['id' => $structure->id]) }}">
                    ...
                    <div class="column">
                          ...
                          <div class="column">
                            ...
                            <label for="add2_subdistrict" class="">แขวง</label>
                                ...
                                <input id="add2_subdistrict" type="text" class="form-control" name="add2_subdistrict" value="{{ $structure->add2_subdistrict }}" required autofocus>
                  ...
                  <div class="row">
                    <div class="column">
                            ...
                            <label for=" add2_district" class="">เขต</label>
                                ...
                                <input id=" add2_district" type="text" class="form-control" name=" add2_district" value="{{ $structure->add2_district }}" required autofocus>
                        ...
                        <div class="column">
                            ...
                            <label for="add2_city" class="">จังหวัด</label>
                                ...
                                <input id="add2_cityr" type="text" class="form-control" name="add2_city" value="{{ $structure->add2_city }}" required autofocus>
                          ...
                          <div class="column">
                            ...
                            <label for="add2_country" class="">ประเทศ</label>
                                ...
                                <input id="add2_country" type="text" class="form-control" name="add2_country" value="{{ $structure->add2_country }}" required autofocus>

    ...
    <div class="row">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('organizeadmin.store') }}">
                        {{ csrf_field() }}
                      ...
                      <div class="column">
                        ...
                        <div class="column">
                          <label for="id_num" class="">เลขที่นิติบุคคล</label>
                              ...
                              <input id="id_num" type="id_num" class="form-control" name="id_num" value="{{ old('id_num') }}" required>
                        ...
                        <div class="column">
                              ...
                              <input  style="width:30%;display: inline;" class="form-control" name="sd"size="3"  placeholder="วันที่"  />
                              -

                                <input  style="width:30%;display: inline;"class="form-control" name="sm"  size="3" placeholder="เดือนที่" />
                              -
                              <input type="text" style="width:30%;display: inline;" class="form-control"name="sy"  size="3" placeholder="ปี ค.ศ." >
                  ...
                  <div class="row">
                    ...
                    <div class="column">
                          ...
                          <label for="email" class="">ประเภทธุรกิจ</label>
                              ...
                              <input id="more" type="more" class="form-control" name="more" value="{{ old('more') }}" required>
                    ...
                    <div class="column">
                          ...
                          <div class="column">
                                ...
                                <input id="couple_email" type="text" class="form-control" name="couple_email" value="{{ old('couple_email') }}" required autofocus>
                  ...
                  <div class="row">
                    ...
                    <div class="column">
                            ...
                            <label for="name" class="">ที่ตั้งบริษัทเลขที่</label>
                                ...
                                <input id="add2" type="text" class="form-control" name="add2" value="{{ old('add2') }}" required autofocus>
                          ...
                          <div class="column">
                                ...
                                <input id="add2_alley" type="text" class="form-control" name="add2_alley" value="{{ old('add2_alley') }}" required autofocus>
                    ...
                    <div class="column">
                            ...
                            <label for="add2_road" class="">ถนน</label>
                                ...
                                <input id="add2_road" type="text" class="form-control" name="add2_road" value="{{ old('add2_road') }}" required autofocus>
                          ...
                          <div class="column">
                            ...
                            <label for="add2_subdistrict" class="">แขวง</label>
                                ...
                                <input id="add2_subdistrict" type="text" class="form-control" name="add2_subdistrict" value="{{ old('add2_subdistrict') }}" required autofocus>
                  ...
                  <div class="row">
                    <div class="column">
                            ...
                            <label for=" add2_district" class="">เขต</label>
                                ...
                                <input id=" add2_district" type="text" class="form-control" name=" add2_district" value="{{ old(' add2_district') }}" required autofocus>
                        ...
                        <div class="column">
                            ...
                            <label for="add2_city" class="">จังหวัด</label>
                                ...
                                <input id="add2_cityr" type="text" class="form-control" name="add2_city" value="{{ old('add2_city') }}" required autofocus>
                          ...
                          <div class="column">
                            ...
                            <label for="add2_country" class="">ประเทศ</label>
                                ...
                                <input id="add2_country" type="text" class="form-control" name="add2_country" value="{{ old('add2_country') }}" required autofocus>
                        ...
                        <div class="column">
                            ...
                            <label for="add2_postcode" class="">หมายเลขไปรษณีย์</label>
                                ...
                                <input id="add2_postcode" type="text" class="form-control" name="add2_postcode" value="{{ old('add2_postcode') }}" required>
                    ...
                    <div class="column">
                      ...
                      <label for="emergency_email" class="">อีเมลล์</label>
                        ...
                        <div class="column">
                            ...
                            <label for="password" class="">รหัสผ่านสำหรับเข้าใช้งานระบบ</label>

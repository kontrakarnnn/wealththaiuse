    ...
    <div class="row">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('offeruser.store') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="row">
                          <div class="column">
                            ...
                            <div class="column">
                              ...
                              <select  class="form-control condition" name="type_id" required autofocus>
                  ...
                  <div class="row">
                    ...
                    <select id="promotion_id" class="form-control " name="promotion_id" onchange="chgtext()">
                    <option value="" >-select-</option>
                  ...
                  <div class="row">
                    <div class="column">
                      ...
                      <select  class="form-control name" name="proposal_id" required autofocus>
                        <option value="" >-select-</option>
              ...
              <div class="row">
                      ...
                      <div class="column">
                        ...
                        <select  class="form-control name" name="ref_member_id" id="ref_member_id" onchange="selectbranch()" required autofocus>
                          <option value="" >-select-</option>
...
<div class="row">
  <div class="column">
    ...
    <div class="lacampay">
        ...
        <input id="offer_payment_value1"  onKeyUp="chgtext()"  type="text" class="form-control" name="offer_payment_value1"  value="{{ old('offer_payment_value1') }}" >
</div>
</div>
  ...
  <div class="column">
    ...
    <div class="lacampay2">
        ...
        <input id="offer_payment_value2"  onKeyUp="chgtext()"  type="text" class="form-control" name="offer_payment_value2"  value="{{ old('offer_payment_value2') }}" >
      </div>
    </div>
...
<div class="lacampay3">
    ...
    <input id="offer_payment_value3"  onKeyUp="chgtext()" type="text" class="form-control" name="offer_payment_value3"  value="{{ old('offer_payment_value3') }}" >
</div>
</div>
...
<input id="offer_payment_value4" readonly onKeyUp="chgtext()"type="text" class="form-control " name="offer_payment_value4"  value="{{ old('offer_payment_value4') }}" >
</div>
</div>
...
<input id="offer_payment_value9" readonly type="text" class="form-control " name="offer_payment_value9"  value="{{ old('offer_payment_value9') }}" >
</div>
</div>
...
<div class="lacampay10">

<input id="offer_payment_value10" type="text" class="form-control " readonly name="offer_payment_value10"  value="{{ old('offer_payment_value10') }}" >
</div>
</div>
...
@endif
  ...
  <div class="column">
    ...
    <div class="lacampay11">

        <input id="offer_payment_value11" type="text" class="form-control" name="offer_payment_value11"  readonly value="{{ old('offer_payment_value11') }}" >
</div>
</div>
...
<div style="overflow-x:auto;">
    ...
    <tbody>
      <tr role="row" class="odd">
        ...
        <td><input class="form-control" readonly id="lastshow1"/></dh>
      </tr>
      <tr role="row" class="odd">
        <th>ยอดหัก ณ ที่จ่าย * (ถ้ามีค่า)</th>
        <td><input class="form-control" readonly id="lastshow2"/></dh>
      </tr>
      <tr role="row" class="odd">
        <th>ส่วนลดพิเศษทั้งหมด </th>
        <td><input class="form-control" readonly id="lastshow3"/></dh>
      </tr>
      <tr role="row" class="odd">
        <th>ค่าใช้จ่ายสุทธิที่ลูกค้าต้องจ่ายก่อนหัก ณ ที่จ่าย   (Customer)</th>
        <td><input class="form-control" readonly id="lastshow4"/></dh>
      </tr>
      <tr role="row" class="odd">
        <th>ค่าใช้จ่ายสุทธิที่ลูกค้าต้องจ่ายหลังหัก ณ ที่จ่าย   (Customer)</th>
        <td><input class="form-control" readonly id="lastshow5"/></dh>
      </tr>
      <tr role="row" class="odd">
        <th>ค่าใช้จ่ายสุทธิที่ให้คำปรึกษา/แนะนำ ต้องจ่ายให้แก่บริษัท  (Partner) </th>
        <td><input class="form-control" readonly id="lastshow6"/></dh>
      </tr>
      <tr role="row" class="odd">
        <th>ค่าใช้จ่ายสุทธิที่ผู้ให้บริการ ต้องจ่ายให้แก่บริษัท  (User) /(เบี้ยที่ผู้แจ้งงานต้องโอนเดิม)</th>
        <td><input class="form-control" readonly id="lastshow7"/></dh>
      </tr>
      <tr role="row" class="odd">
        <th>ค่าใช้จ่ายสุทธิที่บริษัทต้องโอนไปบริษัทประกัน (Company)</th>
        <td><input class="form-control" readonly id="lastshow8"/></dh>
      </tr>
    </tbody>
  </table>
</div>
  ...
  <!-- /.box-body -->
                ...
                $.ajax({
                    ...
                    success:function(data){
                     ...
                     console.log(data.length);
                      ...
                      {
                        oppay9+='<div><label for="offer_payment_value9" class="lasd">'+data[i].offer_payment_name9+'</label><div class="lacampay9"><input id="offer_payment_value9" readonly type="text" class="form-control " name="offer_payment_value9" value="{{ old('offer_payment_value9') }}" ></div></div>';
                      }
                      else{
                        oppay9+='';
                      }
                      ...
                      {
                        oppay11+='<div><label for="offer_payment_value11" class="lasd">'+data[i].offer_payment_name11+'</label><div class="lacampay11"><input id="offer_payment_value11" readonly type="text" class="form-control " name="offer_payment_value11" value="{{ old('offer_payment_value11') }}" ></div></div>';
                      }
                      else{
                        oppay11+='';
                    ...
                    {
                      oppay19+='<div><label for="offer_payment_value19" class="lasd">'+data[i].offer_payment_name19+'</label><div class="lacampay19"><input id="offer_payment_value19" type="text" class="form-control " readonly onKeyUp="chgtext()" name="offer_payment_value19" value="{{ old('offer_payment_value19') }}" ></div></div>';
                    }
                    else{
                      oppay19+='';
                    }
                ...
                $.ajax({
                    ...
                    success:function(data){
                     ...
                     if(data.length == null || data.length <= 0)
                     {
                      ...
                      for(var i=0; i<data.length;i++){
                      //  op+='<label value="'+data[i].con_para_name1+'">'+data[i].con_para_name1+'</label>';
                      console.log(data[i].offer_value1);
                        //op+='<input id="offer_value1" type="text" class="form-control " name="offer_value1" value="'+data[i].offer_value_name1+'" >';
                        ...
                        if(data[i].offer_payment_value_flag9 == 1)
                        {
                          ...
                          {
                          opcampay9+='<div class="input"><input id="offer_payment_value9" readonly type="text" readonly class="form-control" name="offer_payment_value9"  value='+data[i].offer_payment_value9+' ></div>';
                          }
                          else{
                            opcampay9+='<input id="offer_payment_value9" type="text" readonly class="form-control" readonly name="offer_payment_value9"   >';
                          }
                        }
                        else{
                        //  opcampay+='<input id="offer_payment_value2"  onKeyUp="chgtext()"type="text" class="form-control" name="offer_payment_value2"   >';
                        ...
                        if(data[i].offer_payment_value_flag17 == 1)
                        {
                          ...
                          opcampay17+='<div class="input"><input id="offer_payment_value17" readonly type="text" class="form-control" name="offer_payment_value17"  value='+data[i].offer_payment_value17+' ></div>';
                            ...
                            opcampay17+='<input id="offer_payment_value17" type="text" readonly class="form-control" name="offer_payment_value17"   >';
                          }
                        }
                        else{
                        //  opcampay+='<input id="offer_payment_value2"  onKeyUp="chgtext()"type="text" class="form-control" name="offer_payment_value2"   >';
                        ...
                        if(data[i].offer_payment_value_flag18 == 1)
                        {
                          ...
                          opcampay18+='<div class="input"><div class="input-group date"><input id="offer_payment_value18" readonly type="text" class="form-control" name="offer_payment_value18"  value='+data[i].offer_payment_value18+' ><div class="input-group-addon"> <span class="userquota"></span></div></div>';
                            ...
                            opcampay18+='<div class="input-group date"><input id="offer_payment_value18" type="text" readonly class="form-control" name="offer_payment_value17"   ><div class="input-group-addon"> <span class="userquota"></span></div></div>';
                          }
                        }
                        else{
                        //  opcampay+='<input id="offer_payment_value2"  onKeyUp="chgtext()"type="text" class="form-control" name="offer_payment_value2"   >';
                        ...
                        if(data[i].offer_payment_value_flag19 == 1)
                        {
                          ...
                          {
                          opcampay19+='<div class="input"><input id="offer_payment_value19" readonly type="text" class="form-control" name="offer_payment_value19"  value='+data[i].offer_payment_value19+' ></div>';
                          }
                          else{
                            opcampay19+='<input id="offer_payment_value19" type="text" readonly class="form-control" name="offer_payment_value19"   >';
                          }
                        }
                        else{
                        //  opcampay+='<input id="offer_payment_value2"  onKeyUp="chgtext()"type="text" class="form-control" name="offer_payment_value2"   >';
    ...
    $('.lacampay40').append(opcampay40);
                      ...
                      {
                         x4 = document.getElementById('offer_payment_value4').value;
                      console.log("Mode2");
                      var numbercal = document.getElementById('offer_payment_value7').value;
                      ...
                      var xansmemlevel =Number(catco) * Number(memlevel)/100;
                        ...
                        console.log("Oquota"+oquota);
                        console.log("pquota"+pquota);
    ...
    if(mode.checked == true)
    {
      console.log(mode);
      var x1 = document.getElementById('offer_payment_value1').value;
      document.getElementById('offer_payment_value5').value = Number(x1) * Number(1)/100;
      document.getElementById('lastshow2').value = Number(x1) * Number(1)/100;
    }
    else
    {

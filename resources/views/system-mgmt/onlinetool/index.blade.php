@extends('system-mgmt.onlinetool.base')
@section('action-content')
  ...
  <div class="box-body">
      ...
      <form method="POST" action="{{ route('onlinetool.search') }}">
         {{ csrf_field() }}
        ...
        <table id="example2" class="table  table-hover dataTable" role="grid" aria-describedby="example2_info">
            ...
            @foreach ($data as $i => $da)
				...
				@endif
					...
					<td><a class="btn btn-info" href="https://erp.wealththai.net/SecurityBroke/per?{{ $da->Portfolio->member_id }}">View Information</a></td>
              </tr>
            @endforeach
            </tbody>
            <tfoot>

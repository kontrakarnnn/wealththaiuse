...
@section('action-content')
  ...
  <div class="box-body">
    ...
    <div id="example2_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
      ...
      <td >  <a style="color:black" href="{{ URL::to('admin/portfolioadmin/uploadfile',[$r,$portnumber,'ref1ref',$filecat,$filerefname])}}"><button>Add File</button></a></td >
        @else
        @foreach ($files1 as $key =>$re)

        <td ><a  style="font-size:16px" href="{{ URL::to('admin/showfile',[$re->id])}}" >{{$re->file_public_name}}</a><br /> <a style="color:black" href="{{ URL::to('admin/portfolioadmin/editfile',[$r,$portnumber,'ref1ref',$filecat,$filerefname,$re->id])}}"><button>Edit File</button></a></td>
        @endforeach
      ...
      <tr>
        ...
        <td >  <a style="color:black" href="{{ URL::to('admin/portfolioadmin/uploadfile',[$r,$portnumber,'ref2ref',$filecat,$filerefname])}}"><button>Add File</button></a></td >
        @else
        @foreach ($files2 as $key =>$ree)
        <td ><a style="font-size:16px" href="{{ URL::to('admin/showfile',[$ree->id])}}" >{{$ree->file_public_name}}</a><br /> <a style="color:black" href="{{ URL::to('admin/portfolioadmin/editfile',[$r,$portnumber,'ref2ref',$filecat,$filerefname,$ree->id])}}"><button class="">Edit File</button></a></td>
      ...
      <td >  <a style="color:black" href="{{ URL::to('admin/portfolioadmin/uploadfile',[$r,$portnumber,'ref3ref',$filecat,$filerefname])}}"><button >Add File</button></a></td >
        @else
        @foreach ($files3 as $key =>$reee)
        <td ><a style="font-size:16px" href="{{ URL::to('admin/showfile',[$reee->id])}}" >{{$reee->file_public_name}}</a><br /> <a style="color:black;" href="{{ URL::to('admin/portfolioadmin/editfile',[$r,$portnumber,'ref3ref',$filecat,$filerefname,$reee->id])}}"><button>Edit File</button></a></td>

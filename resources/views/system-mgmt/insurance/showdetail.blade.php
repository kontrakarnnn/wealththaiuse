          ...
          <div class="col-sm-12">
            <div class="card">
              <div class="card-header">
                <div id="caseheader" data-id="{{ $id }}" data-recheckflag="{{$caseheaderrecheckofferflag}}" data-casename="{{ $caseheadername }}" data-prevnote="{{ $caseheadernotefromprevious }}" data-renewnote="{{ $caseheadernotecopytorenew }}" data-membernote="{{ $caseheadernotefrommember }}"
              ...
              <div id="subdata" data-id="{{ $id }}" data-varname47="{{$casevarname47}}" data-varname48="{{$casevarname48}}" data-varname49="{{$casevarname49}}" data-varname50="{{$casevarname50}}" data-varvalue47="{{$casevarvalue47}}" data-varvalue48="{{$casevarvalue48}}" data-varvalue49="{{$casevarvalue49}}" data-varvalue50="{{$casevarvalue50}}">
                ...
                <div class="column">
                  ...
                  <div class="column">
                    ...
                    <div class="" id="casepayment" data-id="{{ $id }}" data-varvalue10="{{$casetrackingvarvalue10 }}" data-varvalue9="{{$casetrackingvarvalue9 }}" data-varvalue8="{{$casetrackingvarvalue8 }}" data-varname28="{{ $casevarname28 }}" data-varname29="{{ $casevarname29 }}" data-varname51="{{ $casevarname51 }}"

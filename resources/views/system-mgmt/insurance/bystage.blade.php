  ...
  <div class="box-header">
    <div class="row">
      <div class="col-sm-6">
        ...
        @if($flagbutton == 1)
        <a href="/wealththaiinsurance/all/case/stage" class="btn btn-margin btn-default">ดูเฉพาะงานตัวเอง</a>
        @else
          <a href="/wealththaiinsurance/all/case/stage?alludb=1" class="btn btn-margin btn-default">ดูงานทั้งหมดที่มีสิทธิ</a>
        @endif

...
@foreach ($findoffer as $index =>$chunk)
        <table style='margin-top:160px' class='table'>
          ...
          <tr>
            <th class='table'style='background-color:#dedee3;text-align:left; '>ภาษีหัก ณ ที่จ่าย</th>
            @foreach($chunk as $findof)
            <td class='table'>{{$findof->offer_payment_value5}}</td>
            @endforeach
          </tr>
          <tr>
            <th class='table'style='background-color:#dedee3;text-align:left; '>ค่าคอมมิชชั่นผู้ให้บริการ</th>
            @foreach($chunk as $findof)
            <td class='table'>{{$findof->offer_payment_value19}}</td>
            @endforeach
          </tr>
          <tr>
            <th class='table'style='background-color:#dedee3;text-align:left; '>เบี้ยที่ผู้ให้บริการต้องชำระ</th>
            @foreach($chunk as $findof)
            @php
            $result = $findof->offer_payment_value4- $findof->offer_payment_value15;
        ...
        @foreach ($findofferact as $chunk)
                ...
                @foreach ($findoffertax as $chunk)
                    <br /><br /><br /><br />  <br /><p style='margin-top:20px'>&nbsp;</p>
                        <table style='' class='table'>
                          ...
                          <tr>
                            <th class='table'style='background-color:#dedee3;text-align:left;width:50% '>ชื่อบริษัท</th>
                            <td class='table'>กรมขนส่งทางบก</td>
                          </tr>

                          <tr>
                            <th class='table'style='background-color:#dedee3;text-align:left;width:50% '>ชนิดกรมธรรม์</th>
                            @foreach($chunk as $findof)
                            <td class='table'>{{$findof->OfferType->name}}</td>
                            @endforeach
                          </tr>
                          ...
                          <tr>
                            <th class='table'style='background-color:#dedee3;text-align:left;width:50% '>เบียสุทธิ</th>
                            @foreach($chunk as $findof)
                            <td class='table'>{{$findof->offer_payment_value1}}</td>
                            @endforeach
                          </tr>
                          <tr>
                            <th class='table'style='background-color:#dedee3;text-align:left;width:50% '>อากรแสตมป์</th>
                            @foreach($chunk as $findof)
                            <td class='table'>{{$findof->offer_payment_value2}}</td>
                            @endforeach
                          </tr>
                          <tr>
                            <th class='table'style='background-color:#dedee3;text-align:left;width:50% '>ภาษีมูลค่าเพิ่ม</th>
                            @foreach($chunk as $findof)
                            <td class='table'>{{$findof->offer_payment_value3}}</td>
                            @endforeach
                          </tr>
                          <tr>
                            <th class='table'style='background-color:#dedee3;text-align:left;width:50% '>ยอดสุทธิ</th>
                            @foreach($chunk as $findof)
                            <td class='table'>{{$findof->offer_payment_value4}}</td>
                            @endforeach
                          </tr>
                          <tr>
                            <th class='table'style='background-color:#dedee3;text-align:left;width:50% '>ส่วนลดพิเศษ</th>
                            @foreach($chunk as $findof)
                            <td class='table'>{{$findof->offer_payment_value15}}</td>
                            @endforeach
                          </tr>
                          <tr>
                            <th class='table'style='background-color:#dedee3;text-align:left;width:50% '>ราคาจ่ายจริง (เฉพาะชำระเงินสด)</th>
                            @foreach($chunk as $findof)
                            @php
                            $result = $findof->offer_payment_value4- $findof->offer_payment_value15;
                            @endphp
                          ...
                          <tr>
                            <th class='table'style='background-color:#dedee3;text-align:left;width:50% '>หมายเหตุ</th>
                            @foreach($chunk as $findof)
                            <td class='table'>{{$findof->offer_value18}}</td>
                            @endforeach
                          </tr>
                          <tr>
                            <th class='table'style='background-color:#dedee3;text-align:left;width:50% '>ภาษีหัก ณ ที่จ่าย</th>
                            @foreach($chunk as $findof)
                            <td class='table'>{{$findof->offer_payment_value5}}</td>
                            @endforeach
                          </tr>
                          <tr>
                            <th class='table'style='background-color:#dedee3;text-align:left;width:50% '>ค่าคอมมิชชั่นผู้ให้บริการ</th>
                            @foreach($chunk as $findof)
                            <td class='table'>{{$findof->offer_payment_value19}}</td>
                            @endforeach
                          </tr>
                          <tr>
                            <th class='table'style='background-color:#dedee3;text-align:left;width:50% '>เบี้ยที่ผู้ให้บริการต้องชำระ</th>
                            @foreach($chunk as $findof)
                            @php
                            $result = $findof->offer_payment_value4- $findof->offer_payment_value15;
                            $result2 = $result-$findof->offer_payment_value5;

    ...
    <div id="example2_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
      <div class="row">
        <div class="col-sm-12">
          ...
          <div id="insuranceshowoffer" data-offervaluename5 ="{{$offervaluename5}}" data-offervaluename6 ="{{$offervaluename6}}" data-offervaluename7 ="{{$offervaluename7}}" data-offervaluename1 ="{{$offervaluename1}}" data-offervaluename14 ="{{$offervaluename14}}" data-offervaluename19 ="{{$offervaluename19}}"

    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">Update subdistrict</div>
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('block.update', ['id' => $block->id]) }}">
                                        ...
                                        <div class="col-md-6">
                                          <select class=" form-control department" name="district_id">
                                            ...
                                            @foreach ($structures as $structure)
                                              <option value="{{$structure->id}}"{{$structure->id == $block->district_id ? 'selected' : ''}}>{{$structure->name_in_thai}}</option>
                                                @endforeach
                        ...
                        <div class="form-group{{ $errors->has('latitude') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="latitude" type="text" class="form-control" name="latitude" value="{{$block->latitude}}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('longitude') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="longitude" type="text" class="form-control" name="longitude" value="{{$block->longitude}}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('zip_code') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="zip_code" type="text" class="form-control" name="zip_code" value="{{$block->zip_code}}" required autofocus>

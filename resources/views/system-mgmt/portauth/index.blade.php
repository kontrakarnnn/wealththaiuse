...
<script src="http://ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.js"></script>
    ...
    <div  class="dataTables_wrapper form-inline dt-bootstrap">
      ...
      <div class="form-group">
        <div class="col-sm-12">
          ...
          <form class="form-horizontal" role="form" method="POST" action="{{ route('portauth.store') }}">
              {{ csrf_field() }}
  ...
  @endforeach
                  ...
                  <th width="" class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="port: activate to sort column ascending">port</th>
                          <th  class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="port: activate to sort column ascending">Member(Email)</th>
                      ...
                      <tbody>
                        {{$userauths}}
                          ...
                          <tr>
                            ...
                            <td><div class="col-md-6"><select class=" form-control " name="port_id[]" id="nameid2" required autofocus>
                            ...
                            <td>
                             ...
                             <input type="text" name="member_id[]" class="form-control member_id" required autofocus>
                            </td>

...
<div class="container">
    <div class="row">
        <div class="">
            <div class="panel panel-default">
                <div class="panel-heading">Update Case Type Config</div>
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('case-type-config.update', ['id' => $data->id]) }}">
                        ...
                        <div class="row">
                          <div class="columndesc">
                            <label for="sub_type_config_name" class="">Sub Type Config Name</label>
                                ...
                                <input id="sub_type_config_name" type="text" class="form-control" name="sub_type_config_name" value="{{ $data->sub_type_config_name}}" >
                  ...
                  <div class="row">
                    <div class="column">
                      ...
                      <label for="name" class="">Config Label1</label>
                          ...
                          <input id="config_label1" type="text" class="form-control" name="config_label1"  value="{{ $data->config_label1  }}" >
                ...
                <div class="column">
                  ...
                  <label for="config_label2" class="">Config Label2</label>
                      ...
                      <input id="config_label2" type="text" class="form-control" name="config_label2"  value="{{$data->config_label2  }}" >
            ...
            <div class="column">
              ...
              <label for="config_label3" class="">Config Label3</label>
                  ...
                  <input id="config_label3" type="text" class="form-control" name="config_label3"  value="{{$data->config_label3  }}" >
        ...
        <div class="column">
          ...
          <label for="config_label4" class="">Config Label4</label>
              ...
              <input id="config_label4" type="text" class="form-control" name="config_label4"  value="{{ $data->config_label4  }}" >
    ...
    <div class="column">
      ...
      <label for="config_label5" class="">Config Label5</label>
          ...
          <input id="config_label5" type="text" class="form-control" name="config_label5"  value="{{ $data->config_label5  }}" >
            ...
            <div class="row">
              <div class="column">
                ...
                <label for="config_label6" class="">Config Label6</label>
                    ...
                    <input id="config_label6" type="text" class="form-control" name="config_label6"  value="{{ $data->config_label6  }}" >
              ...
              <div class="column">
                ...
                <label for="config_label7" class="">Config Label7</label>
                    ...
                    <input id="config_label7" type="text" class="form-control" name="config_label7"  value="{{ $data->config_label7  }}" >
          ...
          <div class="column">
            ...
            <label for="config_label8" class="">Config Label8</label>
                ...
                <input id="config_label8" type="text" class="form-control" name="config_label8"  value="{{ $data->config_label8  }}" >
      ...
      <div class="column">
        ...
        <label for="config_label9" class="">Config Label9</label>
            ...
            <input id="config_label9" type="text" class="form-control" name="config_label9"  value="{{$data->config_label9  }}" >
  ...
  <div class="column">
    ...
    <label for="config_label10" class="">Config Label10</label>
        ...
        <input id="config_label10" type="text" class="form-control" name="config_label10"  value="{{ $data->config_label10  }}" >
  ...
  <div class="column">
    ...
    <label for="config_value1" class="">Config Value1</label>
        ...
        <input id="config_value1" type="text" class="form-control" name="config_value1"  value="{{ $data->config_value1  }}" >
  ...
  <label for="config_value2" class="">Config Value2</label>
      ...
      <input id="config_value2" type="text" class="form-control" name="config_value2"  value="{{ $data->config_value2  }}" >
  ...
  <label for="config_value3" class="">Config Value3</label>
      ...
      <input id="config_value3" type="text" class="form-control" name="config_value3"  value="{{ $data->config_value3  }}" >
  ...
  <label for="config_value4" class="">Config Value4</label>
      ...
      <input id="config_value4" type="text" class="form-control" name="config_value4"  value="{{ $data->config_value4   }}" >
  ...
  <label for="config_value5" class="">Config Value5</label>
      ...
      <input id="config_value5" type="text" class="form-control" name="config_value5"  value="{{$data->config_value5  }}" >
  ...
  <div class="column">
    ...
    <label for="config_value6" class="">Config Value6</label>
        ...
        <input id="config_value6" type="text" class="form-control" name="config_value6"  value="{{$data->config_value6  }}" >
  ...
  <div class="column">
    ...
    <label for="config_value7" class="">Config Value7</label>
        ...
        <input id="config_value7" type="text" class="form-control" name="config_value7"  value="{{ $data->config_value7  }}" >
  ...
  <label for="config_value8" class="">Config Value8</label>
      ...
      <input id="config_value8" type="text" class="form-control" name="config_value8"  value="{{ $data->config_value8  }}" >
  ...
  <label for="config_value9" class="">Config Value9</label>
      ...
      <input id="config_value9" type="text" class="form-control" name="config_value9"  value="{{$data->config_value9  }}" >
  ...
  <label for="config_value10" class="">Config Value10</label>
      ...
      <input id="config_value10" type="text" class="form-control" name="config_value10"  value="{{ $data->config_value10  }}" >

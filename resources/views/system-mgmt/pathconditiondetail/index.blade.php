...
@section('action-content')
  ...
  <div class="box-header">
    <div class="row">
        <div class="col-sm-8">
          <h3 class="box-title">List of Path Condition Detail</h3>
        </div>
        <div class="col-sm-4">
          <a class="btn btn-primary" href="{{ route('pathconditiondetail.create') }}">Add new</a>
        </div>
    </div>
  </div>
  <!-- /.box-header -->
  <div class="box-body">
      ...
      <form method="POST" action="{{ route('pathconditiondetail.search') }}">
         {{ csrf_field() }}
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="form-group">
                  ...
                  <label for="file_category_name" class="col-sm-3 control-label">Path Condition Detail Name</label>
                  <div class="col-md-9">
            ...
            <div class="col-md-6">
              <div class="form-group">
                  ...
                  <label for="file_category_name" class="col-sm-3 control-label">Condition </label>
                  <div class="col-md-9">

                    <select  class="form-control name" name="condition_id">
                     <option value="" ></option>
    ...
    <div id="example2_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
      <div class="row">
        <div class="col-sm-12">
          <a  style="color:blue"href="/admin/pathconditiondetail" for="file_category_name" class="btn btn-default "> ShowAll </a>

			<div style="overflow-x:auto;">
          <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
            <thead>
              <tr role="row">
                <th >Path Condition Detail Name</th>
            ...
            @foreach ($data as $da)
                <tr role="row" class="odd">
                  <td>{{$da->name}}</td>
                  @if($da->condition_id == NULL)
                  <td></td>
                  @else
                  <td>{{$da->Condition->name}}</td>
                  @endif
                  <td>{{$da->description}}</td>
                  <td>
                    <form class="row" method="POST" action="{{ route('pathconditiondetail.destroy', ['id' =>$da->id]) }}" onsubmit = "return confirm('Are you sure?')">
                        ...
                        <a href="{{ route('pathconditiondetail.edit', ['id' => $da->id]) }}" class="btn btn-warning  btn-margin">
                        Update
                        </a>

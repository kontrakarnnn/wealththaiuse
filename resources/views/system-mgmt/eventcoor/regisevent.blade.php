        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('eventtomembercoor.store') }}">
                        {{ csrf_field() }}
                      ...
                      <label class="col-md-4 control-label">My Lead</label>
                        ...
                        <div class="form-group{{ $errors->has('note') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <p id="note" type="text" class="" name="note"  ><b >Total Participant <b style="color:red">{{$eventcount}}</b></b></p>

              ...
              <div class="col-md-8 col-md-offset-2">
                  <div class="panel panel-default">
                      ...
                      <div class="panel-body">
                        ...
                        <form class="" role="form" method="POST" action="{{ route('reflink.storecontentlink') }}">
                            {{ csrf_field() }}

                                  <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                      <label for="name" class="">Input Content Link</label>

                                      <div class="">
                                        <textarea id="link2"  name="website" placeholder="Input Content Link Here" class="form-control"  type="text" required>{{$website}}</textarea>
                                      </div>
                                  </div>
                                  <div class="row">
                                    <div class="column">
                                  ...
                                  <a href="/reflink/content/link" class="btn btn-danger btn-margin">Clear</a>
                                  </div>
                                </div>
                                </form>

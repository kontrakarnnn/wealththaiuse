              ...
              <div class="col-md-8 col-md-offset-2">
                  <div class="panel panel-default">
                      ...
                      <div class="panel-body">
                        ...
                        <form class="" role="form" method="POST" action="{{ route('reflink.storeeventlink') }}">
                            {{ csrf_field() }}
                          ...
                          <a href="/reflink/event/link" class="btn btn-danger btn-margin">Clear</a>
                                  ...
                                  <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}" style="border-style: groove;padding:10px">
                                      ...
                                      <div class="">
                                        <textarea id="link4"class="form-control" readonly="readonly" type="text" value="{{ url('/quickregister') . '?/eventmember/eventregis/' . $eventl . '/event??UTM??utm_source='. $source. '&utm_content=' . $content . '&utm_medium=' . $medium . '&utm_name=' . $name . '&utm_term=' . $term  }}">{{ $eventlink. '?/eventmember/eventregis/' . $eventl . '/event??UTM??utm_source='. $source. '&utm_content=' . $content . '&utm_medium=' . $medium . '&utm_name=' . $name . '&utm_term=' . $term  }}</textarea>
                                ...
                                <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}" style="border-style: groove;padding:10px">
                                    <label for="name">Quick Register Before Event Day</label>

                                    <div class="">
                                      <textarea id="link4"class="form-control" readonly="readonly" type="text" value="{{ url('/quickregister') . '?/eventmember/eventregis/' . $eventl . '/event??UTM??utm_source='. $source. '&utm_content=' . $content . '&utm_medium=' . $medium . '&utm_name=' . $name . '&utm_term=' . $term  }}">{{ url('/quickregister') . '?/eventmember/eventregis/' . $eventl . '/event??UTM??utm_source='. $source. '&utm_content=' . $content . '&utm_medium=' . $medium . '&utm_name=' . $name . '&utm_term=' . $term  }}</textarea>

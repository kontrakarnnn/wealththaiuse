    ...
    <div class="row">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                  <form class="form-horizontal" role="form" method="POST" action="{{ route('branch.update', ['id' => $branch->id]) }}">
                    ...
                    <div class="column">
                          ...
                          <div class="column">
                            ...
                            <label for="add_subdistrict" class="">แขวง</label>
                                ...
                                <input id="add_subdistrict" type="text" class="form-control" name="add_subdistrict" value="{{ $branch->add_subdistrict }}" required autofocus>
                  ...
                  <div class="row">
                    <div class="column">
                            ...
                            <label for=" add_district" class="">เขต</label>
                                ...
                                <input id=" add_district" type="text" class="form-control" name=" add_district" value="{{$branch->add_district}}" required autofocus>
                        ...
                        <div class="column">
                            ...
                            <label for="add_city" class="">จังหวัด</label>
                                ...
                                <input id="add_city" type="text" class="form-control" name="add_city" value="{{ $branch->add_city }}" required autofocus>
                          ...
                          <div class="column">
                            ...
                            <label for="add2_country" class="">ประเทศ</label>
                                ...
                                <input id="add_country" type="text" class="form-control" name="add_country" value="{{ $branch->add_country}}" required autofocus>

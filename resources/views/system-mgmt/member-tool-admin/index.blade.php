...
@section('action-content')
  ...
  <div class="box-header">
    <div class="row">
        ...
        <div class="col-sm-4">
          <a class="btn btn-primary" href="{{ route('member-tool-admin.create') }}">Add Tool To Member</a>
        </div>
    </div>
  </div>
  <!-- /.box-header -->
                ...
                <tr role="row" class="odd">
                  ...
                  <td>
                    <form class="row" method="POST" action="{{ route('member-tool-admin.destroy', ['id' => $da->id]) }}" onsubmit = "return confirm('Are you sure?')">
                        ...
                        <a href="{{ route('member-tool-admin.edit', ['id' => $da->id]) }}" class="btn btn-warning btn-margin">
                        Update
                        </a>

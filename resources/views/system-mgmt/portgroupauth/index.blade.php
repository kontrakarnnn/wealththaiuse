@extends('system-mgmt.portgroupauth.base')
...
<script src="http://ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.js"></script>
    ...
    <div  class="dataTables_wrapper form-inline dt-bootstrap">
      ...
      <div class="form-group">
        <div class="col-sm-12">
          ...
          <form class="form-horizontal" role="form" method="POST" action="{{ route('portgroupauth.store') }}">
              {{ csrf_field() }}
  ...
  @endforeach
                  ...
                  <th width="" class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="port: activate to sort column ascending">port</th>
                          <th  class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="port: activate to sort column ascending">Group</th>
                      ...
                      <tbody>
                        {{$userauths}}
                          ...
                          <tr>
                            ...
                            <td><div class="col-md-6"><select class=" form-control " name="group_id[]" id="nameid2">
          ...
          <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
            <thead>
              <tr role="row">
                <th width="20%" class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="port: activate to sort column ascending">Group</th>
            ...
            @foreach ($userauths as $userauth)
                <tr role="row" class="odd">
                  ...
                  <td>{{ $userauth->group_name }}</td>
                  <td>{{ $userauth->port_name }}</td>


                  <td>{{ $userauth->description}}</td>
                  <td>
                    <form class="row" method="POST" action="{{ route('portgroupauth.destroy', ['id' => $userauth->id]) }}" onsubmit = "return confirm('Are you sure?')">
                        <input type="hidden" name="_method" value="DELETE">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">

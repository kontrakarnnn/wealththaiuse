        ...
        <div class="">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('offer.update', ['id' => $data->id]) }}">
                  ...
                  <div class="row">
                    ...
                    <div class="column">
                      ...
                      <select  class="form-control " name="ref_pid">
                        <option value="" >-select-</option>
                        @foreach ($publicid as $sta)
                            <option value="{{$sta->id}}"{{$sta->id == $data->ref_pid ? 'selected' : ''}}>{{$sta->public_name}} </option>
                        @endforeach &nbsp;
                      </select>
                  ...
                  <div class="row">
                    ...
                    <div class="column">
                      ...
                      <select  class="form-control " name="ref_member_id">
                        <option value="" >-select-</option>
                    ...
                    <div class="column">
                      ...
                      <select  class="form-control " name="ref_branch_id">
                        <option value="" >-select-</option>
...
<label for="offer_payment_value3" class="lapaysd8">@foreach($findoffertype as $fi){{$fi->offer_payment_name31}}@endforeach &nbsp;	</label>

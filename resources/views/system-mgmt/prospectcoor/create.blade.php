        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('prospectcoor.store') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('refered') ? ' has-error' : '' }}">
                            <label for="refered" class="col-md-4 control-label">Refered To</label>

                            <div class="col-md-6">
                              <select  class="form-control nameid" name="refered" >
                                <option valu="0"></option>
                                @foreach($ref as $r)

                                  <option value="{{$r->id}}" >{{$r->public_name}}</option>
                                @endforeach

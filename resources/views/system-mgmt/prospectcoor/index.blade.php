@extends('system-mgmt.prospectcoor.base')
@section('action-content')
  ...
  <div class="box-header">
    <div class="row">
        ...
        <div class="col-sm-4">
          <a class="btn btn-primary" href="{{ route('prospectcoor.create') }}">Add new prospect</a>
        </div>
    </div>
  </div>
  <!-- /.box-header -->
  <div class="box-body">
      ...
      <form method="POST" action="{{ route('prospectcoor.searchnormal') }}">
         {{ csrf_field() }}
      ...
      <form method="POST" action="{{ route('prospectcoor.search') }}">
         {{ csrf_field() }}
        ...
        <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
            ...
            <tbody>
              ...
              <td><select style="color:black" class="  department nameid" name="regis_default_status" onchange="window.location.href=this.value;">
                ...
                <option value="/prospect/priority/{{$l->id}}/1" >1</option>
                <option value="/prospect/priority/{{$l->id}}/2" >2</option>
                <option value="/prospect/priority/{{$l->id}}/3" >3</option>
                <option value="/prospect/priority/{{$l->id}}/4" >4</option>
                <option value="/prospect/priority/{{$l->id}}/5" >5</option>
              </select></td>
              ...
              <option value="/prospect/type/{{$l->id}}/Personal" >Personal</option>
              <option value="/prospect/type/{{$l->id}}/Refered" >Refered</option>
              <option value="/prospect/type/{{$l->id}}/Office" >Office</option>
              <option value="/prospect/type/{{$l->id}}/Special" >Special</option>
              <option value="/prospect/type/{{$l->id}}/Partner" >Partner</option>
              <option value="/prospect/type/{{$l->id}}/Event" >Event</option>
              <option value="/prospect/type/{{$l->id}}/Cold-Calling" >Cold-Calling</option>
              <option value="/prospect/type/{{$l->id}}/Target_Group" >Target_Group</option>
...
<form class="row" method="POST" action="{{ route('prospectcoor.destroy', ['id' => $l->id]) }}" onsubmit = "return confirm('Are you sure?')">
...
<!-- Modal content-->
<form class="form-horizontal" role="form" method="POST" action="{{ route('prospectcoor.update', ['id' =>  $l->id]) }}">
...
<br />
        <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
            ...
            @foreach ($prospect as $num =>$l)
                  ...
                  <td><select style="color:black" class="  department nameid" name="regis_default_status" onchange="window.location.href=this.value;">
                      <option value="{{$l->priority}}" >{{$l->priority}}</option>
                      <option value="/prospectcoor/priority/{{$l->id}}/1" >1</option>
                      <option value="/prospectcoor/priority/{{$l->id}}/2" >2</option>
                      <option value="/prospectcoor/priority/{{$l->id}}/3" >3</option>
                      <option value="/prospectcoor/priority/{{$l->id}}/4" >4</option>
                      <option value="/prospectcoor/priority/{{$l->id}}/5" >5</option>
                  </select></td>
                  <td>{{ $l->name }} {{ $l->lname }}</td>
                  <td>{{ $l->mobile }}</td>
                  <td>{{ $l->email }}</td>
                  <td><select style="color:black" class=" department nameid" name="regis_default_status" onchange="window.location.href=this.value;">
                      ...
                      <option value="" ></option>
                      @foreach ($leadstatus as $sta)
                          <option value="/prospectcoor/status/{{$l->id}}/{{$sta->id}}"{{$sta->id == $l->status ? 'selected' : ''}}>{{$sta->name}}</option>
                      @endforeach
                ...
                <td><select style="color:black" class="  department nameid" name="regis_default_status" onchange="window.location.href=this.value;">
                    <option value="{{$l->priority}}" >{{$l->type}}</option>
                    <option value="/prospectcoor/type/{{$l->id}}/Personal" >Personal</option>
                    <option value="/prospectcoor/type/{{$l->id}}/Refered" >Refered</option>
                    <option value="/prospectcoor/type/{{$l->id}}/Office" >Office</option>
                    <option value="/prospectcoor/type/{{$l->id}}/Special" >Special</option>
                    <option value="/prospectcoor/type/{{$l->id}}/Partner" >Partner</option>
                    <option value="/prospectcoor/type/{{$l->id}}/Event" >Event</option>
                    <option value="/prospectcoor/type/{{$l->id}}/Cold-Calling" >Cold-Calling</option>
                    <option value="/prospectcoor/type/{{$l->id}}/Target_Group" >Target_Group</option>

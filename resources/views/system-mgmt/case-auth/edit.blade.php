        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('case-auth.update', ['id' => $data->id]) }}">
                            ...
                            <div class="col-md-6">
                              <select class="form-control  name" name="public_id">
                                ...
                                @foreach ($public_id as $ca)
                                  <option value={{$ca->id}} {{$ca->id == $data->public_id ? 'selected' : ''}}>{{$ca->public_name}}</option>
                                @endforeach
                              </select>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                              <select class="form-control  name" name="block_partner">
                                ...
                                @foreach ($partnerblock as $ca)
                                  <option value={{$ca->id}} {{$ca->id == $data->block_partner ? 'selected' : ''}}>{{$ca->name}}</option>
                                @endforeach
                              </select>
                            </div>
                        </div>
                        <div class="form-group{{ $errors->has('block_user') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                              <select class="form-control  name" name="block_user">
                                <option value="0" >-Select-</option>
                                @foreach ($block as $ca)
                                  <option value={{$ca->id}} {{$ca->id == $data->block_user ? 'selected' : ''}}>{{$ca->name}}</option>
                                @endforeach
                              </select>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                              <select class="form-control  name" name="guild_member">
                                ...
                                @foreach ($guildmember as $ca)
                                  <option value={{$ca->id}} {{$ca->id == $data->guild_member ? 'selected' : ''}}>{{$ca->name}}</option>
                                @endforeach
                              </select>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                              <select class="form-control  name" name="group_member">
                                ...
                                @foreach ($membergroup as $ca)
                                  <option value={{$ca->id}} {{$ca->id == $data->group_member ? 'selected' : ''}}>{{$ca->name}}</option>
                                @endforeach
                              </select>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                              <select class="form-control  name" name="group_pid">
                                ...
                                @foreach ($pidgroup as $ca)
                                  <option value={{$ca->id}} {{$ca->id == $data->group_pid ? 'selected' : ''}}>{{$ca->name}}</option>
                                @endforeach
                              </select>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                              <select class="form-control  name" name="group_partner">
                                ...
                                @foreach ($partnergroup as $ca)
                                  <option value={{$ca->id}} {{$ca->id == $data->group_partner ? 'selected' : ''}}>{{$ca->name}}</option>
                                @endforeach
                              </select>
                            </div>
                        </div>

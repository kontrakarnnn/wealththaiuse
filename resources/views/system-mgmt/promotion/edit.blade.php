    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">Update  Promotion</div>
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('promotion.update', ['id' => $data->id]) }}">
                        ...
                        <div class="form-group{{ $errors->has('percent_promotion') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <input id="percent_promotion" type="text" class="form-control" name="percent_promotion" value="{{$data->percent_promotion}}" required autofocus>

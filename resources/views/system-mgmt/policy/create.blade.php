        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('policy.store') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('policy') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea rows="8" cols="80" id="link" type="text" class="form-control" name="policy" value="{{ old('policy') }}" ></textarea>

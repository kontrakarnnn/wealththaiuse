    ...
    <div class="row">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('asset-type.store') }}">
                        {{ csrf_field() }}
                        <div class="row">
                          <div class="column">
                      ...
                      <label class="col-md-4 control-label">Port Category</label>
                        ...
                        <div class="form-group{{ $errors->has('la_nla_type') ? ' has-error' : '' }}">
                            <label for="la_nla_type" class="col-md-4 control-label">Type name</label>

                            <div class="col-md-6">
                                <input id="la_nla_type" type="text" class="form-control" name="la_nla_type" >

                                @if ($errors->has('la_nla_type'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('la_nla_type') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="form-group{{ $errors->has('type') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="type" type="text" class="form-control" name="nla_sub_type" value="{{ old('type') }}"  >
                        ...
                        <div class="form-group{{ $errors->has('link_info') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="type" type="text" class="form-control" name="link_info" value="{{ old('link_info') }}"  >
                        ...
                        <div class="form-group{{ $errors->has('ref_name_head') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="type" type="text" class="form-control" name="ref_name_head" value="{{ old('ref_name_head	') }}"  >
                        ...
                        <div class="form-group{{ $errors->has('ref_num_head1') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="type" type="text" class="form-control" name="ref_num_head1" value="{{ old('ref_num_head1	') }}"  >
                        ...
                        <div class="form-group{{ $errors->has('ref_num_head2') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="type" type="text" class="form-control" name="ref_num_head2" value="{{ old('ref_num_head2	') }}"  >
                        ...
                        <div class="form-group{{ $errors->has('ref_num_head3') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="type" type="text" class="form-control" name="ref_num_head3" value="{{ old('ref_num_head3	') }}"  >
                        ...
                        <div class="form-group{{ $errors->has('ref_info_head1') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="type" type="text" class="form-control" name="ref_info_head1" value="{{ old('ref_info_head1	') }}"  >
                        ...
                        <div class="form-group{{ $errors->has('ref_info_head1') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="type" type="text" class="form-control" name="ref_info_head2" value="{{ old('ref_info_head2	') }}"  >
                        ...
                        <div class="form-group{{ $errors->has('ref_info_head1') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="type" type="text" class="form-control" name="ref_info_head3" value="{{ old('ref_info_head3	') }}"  >
                      ...
                      <div class="column">
                        ...
                        <div class="form-group{{ $errors->has('ref_info_head1') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="type" type="text" class="form-control" name="ref_info_head4" value="{{ old('ref_info_head4	') }}"  >
                        ...
                        <div class="form-group{{ $errors->has('ref_info_head1') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="type" type="text" class="form-control" name="ref_info_head5" value="{{ old('ref_info_head5	') }}"  >
                        ...
                        <div class="form-group{{ $errors->has('ref_info_head1') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="type" type="text" class="form-control" name="ref_info_head6" value="{{ old('ref_info_head6	') }}"  >
                        ...
                        <div class="form-group{{ $errors->has('ref_info_head1') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="type" type="text" class="form-control" name="ref_info_head7" value="{{ old('ref_info_head7	') }}"  >
                        ...
                        <div class="form-group{{ $errors->has('ref_info_head1') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="type" type="text" class="form-control" name="ref_info_head8" value="{{ old('ref_info_head8	') }}"  >
                      ...
                      <div class="form-group{{ $errors->has('ref_info_head9') ? ' has-error' : '' }}">
                          ...
                          <div class="col-md-6">
                              <input id="type" type="text" class="form-control" name="ref_info_head9" value="{{ old('ref_info_head9	') }}"  >
                      ...
                      <div class="form-group{{ $errors->has('ref_info_head10') ? ' has-error' : '' }}">
                          ...
                          <div class="col-md-6">
                              <input id="type" type="text" class="form-control" name="ref_info_head10" value="{{ old('ref_info_head10') }}"  >
                      ...
                      <div class="form-group{{ $errors->has('ref_info_head11') ? ' has-error' : '' }}">
                          ...
                          <div class="col-md-6">
                              <input id="type" type="text" class="form-control" name="ref_info_head11" value="{{ old('ref_info_head11	') }}"  >
                      ...
                      <div class="form-group{{ $errors->has('ref_info_head12') ? ' has-error' : '' }}">
                          ...
                          <div class="col-md-6">
                              <input id="type" type="text" class="form-control" name="ref_info_head12" value="{{ old('ref_info_head12	') }}"  >
                      ...
                      <div class="form-group{{ $errors->has('ref_info_head13') ? ' has-error' : '' }}">
                          ...
                          <div class="col-md-6">
                              <input id="type" type="text" class="form-control" name="ref_info_head13" value="{{ old('ref_info_head13	') }}"  >
                      ...
                      <div class="form-group{{ $errors->has('ref_info_head14') ? ' has-error' : '' }}">
                          ...
                          <div class="col-md-6">
                              <input id="type" type="text" class="form-control" name="ref_info_head14" value="{{ old('ref_info_head14') }}"  >
                      ...
                      <div class="form-group{{ $errors->has('ref_info_head15') ? ' has-error' : '' }}">
                          ...
                          <div class="col-md-6">
                              <input id="type" type="text" class="form-control" name="ref_info_head15" value="{{ old('ref_info_head15	') }}"  >
                      ...
                      <div class="form-group{{ $errors->has('ref_info_head16') ? ' has-error' : '' }}">
                          ...
                          <div class="col-md-6">
                              <input id="type" type="text" class="form-control" name="ref_info_head16" value="{{ old('ref_info_head16') }}"  >
                      ...
                      <div class="form-group{{ $errors->has('ref_info_head17') ? ' has-error' : '' }}">
                          ...
                          <div class="col-md-6">
                              <input id="type" type="text" class="form-control" name="ref_info_head17" value="{{ old('ref_info_head17') }}"  >
                      ...
                      <div class="form-group{{ $errors->has('ref_info_head18') ? ' has-error' : '' }}">
                          ...
                          <div class="col-md-6">
                              <input id="type" type="text" class="form-control" name="ref_info_head18" value="{{ old('ref_info_head18	') }}"  >

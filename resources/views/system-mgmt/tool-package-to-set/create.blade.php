    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">Add Tool Package To Tool Set</div>
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('tool-package-to-set.store') }}">
                        {{ csrf_field() }}
                      ...
                      <label class="col-md-4 control-label">Tool Set</label>
                        <div class="col-md-6">
                          <select class=" form-control department nameid" name="tool_set" required autofocus>
                            <option></option>

        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('family.store') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                                      ...
                                      <div class="col-md-6">
                                        <input type="checkbox"  name="approve" value="1">Enable Approve<br>
                                          </div>
                                          </div>
                                          ...
                                          <div class="form-group">
                                                          ...
                                                          <label class="col-md-4 control-label"></label>
                                                        <div class="col-md-6">
                                                          <input type="checkbox"  name="show_mem" value="1"> Show Member Lists<br>
                                                            </div>
                                                            </div>

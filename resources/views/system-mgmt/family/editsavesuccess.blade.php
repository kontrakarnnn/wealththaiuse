      ...
      <div class="col-md-8 col-md-offset-2">
                  ...
                  <form class="form-horizontal" role="form" method="POST" action="{{ route('family.update', ['id' => $structure->id]) }}">
                      ...
                      <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                      <input type="checkbox"  name="approve" {{  $structure->approve =="1" ? 'checked' : '' }} value="1">Enable Approve<br>
                                        </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                                        ...
                                                        <label class="col-md-4 control-label"></label>
                                                      <div class="col-md-6">
                                                        <input type="checkbox"  name="show_mem" value="1" {{  $structure->show_mem =="1" ? 'checked' : '' }}> Show Member Lists<br>
                                                          </div>
                                                          </div>

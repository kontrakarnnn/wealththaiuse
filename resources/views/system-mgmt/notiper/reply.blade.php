                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('notiper.store') }}">
                        ...
                        <div class="form-group{{ $errors->has('sender_note') ? ' has-error' : '' }}">
                            <label for="sender_note" class="col-md-4 control-label">note</label>
                        ...
                        <div class="form-group{{ $errors->has('recieve_id') ? ' has-error' : '' }}">
                            <label for="recieve_id" class="col-md-4 control-label">Public_id</label>

                            <div class="col-md-6">
                                <input id="sender_id" type="text" class="form-control" name="recieve_id" value="{{ $noti->recieve_id }}">

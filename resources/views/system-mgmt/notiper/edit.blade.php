        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('notiper.update', ['id' => $noti->id]) }}">
                      ...
                      <label class="col-md-4 control-label">message_type_id:</label>
                        ...
                        <div class="form-group{{ $errors->has('sender_note') ? ' has-error' : '' }}">
                            <label for="reciever_note" class="col-md-4 control-label">sender_note</label>

                            <div class="col-md-6">
                                <input id="sender_note" type="text" class="form-control" name="reciever_note" value="{{ $noti->sender_note }}" >

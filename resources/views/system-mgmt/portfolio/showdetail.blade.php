      ...
      <div class="row">
        <div class="col-sm-12">
          ...
          <tr>
            ...
            @if($porttype->file_port_ref1 == NULL)
          <td >  <a style="color:black" href="{{ URL::to('SecurityBroke/portfolio/uploadfile',[$r,$portnumber,'ref1ref',$filecat,$filerefname])}}"><button>Add File</button></a></td >
            @else
            @foreach ($files1 as $key =>$re)
              @if($re->status == 'Delete')
              <td style="color:red">this file has been deleted<br /> <a style="color:black" href="{{ URL::to('SecurityBroke/portfolio/uploadfile',[$r,$portnumber,'ref1ref',$filecat,$filerefname])}}"><button>Add File</button></a></td>

              @else
            <td ><a style="font-size:16px" href="{{ URL::to('SecurityBroke/showfile',[$re->id])}}" >{{$re->file_public_name}}</a><br /> 
				{{--<a style="color:black" href="{{ URL::to('SecurityBroke/portfolio/editfile',[$r,$portnumber,'ref1ref',$filecat,$filerefname,$re->id])}}"><button>Edit File</button></a>--}}

              <br />
              <form  role="form" method="POST" action="{{ URL::to('SecurityBroke/file/fakedelete',[$re->id,$r,'ref1ref'])}}" onsubmit = "return confirm('Are you sure?')">
          ...
          <tr>
            ...
            <td >  <a style="color:black" href="{{ URL::to('SecurityBroke/portfolio/uploadfile',[$r,$portnumber,'ref2ref',$filecat,$filerefname])}}"><button>Add File</button></a></td >
            @else
            @foreach ($files2 as $key =>$ree)
            @if($ree->status == 'Delete')
            <td style="color:red">this file has been deleted<br /> <a style="color:black" href="{{ URL::to('SecurityBroke/portfolio/uploadfile',[$r,$portnumber,'ref2ref',$filecat,$filerefname])}}"><button>Add File</button></a></td>

            @else
            <td ><a style="font-size:16px" href="{{ URL::to('SecurityBroke/showfile',[$ree->id])}}" >{{$ree->file_public_name}}</a><br /> 
				{{--<a style="color:black" href="{{ URL::to('SecurityBroke/portfolio/editfile',[$r,$portnumber,'ref2ref',$filecat,$filerefname,$ree->id])}}"><button class="">Edit File</button></a>--}}
              <form  role="form" method="POST" action="{{ URL::to('SecurityBroke/file/fakedelete',[$ree->id,$r,'ref2ref'])}}">
                  <input type="hidden" name="_method" value="PATCH">
                  <input type="hidden" name="_token" value="{{ csrf_token() }}">
          ...
          <td >  <a style="color:black" href="{{ URL::to('SecurityBroke/portfolio/uploadfile',[$r,$portnumber,'ref3ref',$filecat,$filerefname])}}"><button >Add File</button></a></td >
            @else
            @foreach ($files3 as $key =>$reee)
            @if($reee->status == 'Delete')
            <td style="color:red">this file has been deleted<br /> <a style="color:black" href="{{ URL::to('SecurityBroke/portfolio/uploadfile',[$r,$portnumber,'ref3ref',$filecat,$filerefname])}}"><button >Add File</button></a></td>

            @else
            <td ><a style="font-size:16px" href="{{ URL::to('SecurityBroke/showfile',[$reee->id])}}" >{{$reee->file_public_name}}</a><br /> 
				{{--<a style="color:black;" href="{{ URL::to('SecurityBroke/portfolio/editfile',[$r,$portnumber,'ref3ref',$filecat,$filerefname,$reee->id])}}"><button>Edit File</button></a>--}}
              <form  role="form" method="POST" action="{{ URL::to('SecurityBroke/file/fakedelete',[$reee->id,$r,'ref3ref'])}}">
                  <input type="hidden" name="_method" value="PATCH">
                  <input type="hidden" name="_token" value="{{ csrf_token() }}">

    ...
    <div id="example2_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
      <div class="row">
        <div class="col-sm-12">
          ...
          <div class="card-header"><h4>{{$porttype->name}} Asset Details</h4>
            <div class="row">
                <div class="col-sm-8">

                </div>

                  <a class="btn btn-default" href="{{ URL::to('person/asset-transaction/show',[$porttype->id,$portid])}}">Asset Transaction</a>
          ...
          <div class="card-body">
            ...
            <tr>
              ...
              ?>
                <td >   @if($filecatmember == 1)<a style="font-size:16px" href="{{ URL::to('port/showfile',[$a->id])}}" >{{$a->file_public_name}}</a>

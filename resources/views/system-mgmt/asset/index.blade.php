...
@section('action-content')
  ...
  <div class="box-header">
    <div class="row">
        ...
        <div class="col-sm-4">
          <a class="btn btn-primary" href="{{ route('asset.create') }}">Add new asset</a>
        </div>
    </div>
  </div>
  <!-- /.box-header -->
  <div class="box-body">
      ...
      <form method="POST" action="{{ route('asset.search') }}">
         {{ csrf_field() }}
            ...
            <thead>
              <tr role="row">
                ...
                <th width="20%" class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="port: activate to sort column ascending">Name</th>
				  <th width="20%" class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="port: activate to sort column ascending">Referal Name</th>
                ...
                <tr role="row" class="odd">
                  ...
                  <td>
                    <form class="row" method="POST" action="{{ route('asset.destroy', ['id' => $port->id]) }}" onsubmit = "return confirm('Are you sure?')">
                        ...
                        <a href="{{ route('asset.show', ['id' => $port->id]) }}" class="btn btn-info col-sm-3 col-xs-5 btn-margin">
                        Details
                        </a>
                        <a href="{{ route('asset.edit', ['id' => $port->id]) }}" class="btn btn-warning col-sm-3 col-xs-5 btn-margin">
                        Update
                        </a>

...
.card-header{
  ...
  <div class="card">
    <img class="card-img-top" src="{{ asset("/bower_components/AdminLTE/dist/img/avatar5.png") }}" alt="Card image cap">
    <div class="card-body">
...
<input type="hidden"id="sender_id" type="text" class="form-control" name="qti" value="ระบุ วันเวลา และ ช่วงเวลา (ต้องตั้งล่วงหน้า 1 วัน ) ">
            ...
            <h5 class="card-title">{{$serviccenter->group_service_name}}</h5>
            <p class="card-text"></p>
            <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
          </div>
        </div>
            ...
            <p><input class="form-control"  name="ati"></p>
                  ...
                  <input type="hidden"id="sender_id" type="text" class="form-control" name="qti" value="ระบุ วันเวลา และ ช่วงเวลา (ต้องตั้งล่วงหน้า 1 วัน ) ">
                        ...
                        <form class="row" method="POST" action="{{ route('serviceform.destroy', ['id' => $serviccenter->id]) }}" onsubmit = "return confirm('Are you sure?')">
                            <input type="hidden" name="_method" value="DELETE">
                            <input type="hidden" name="_token" value="{{ csrf_token() }}">
                            <a href="{{ route('serviceform.edit', ['id' => $serviccenter->id]) }}" class="btn btn-warning  btn-margin">
                              Update
                            </a>

      ...
      <div class="box">
        ...
        <div class="box-header">
          <div class="row">
              ...
              <div class="col-sm-4">
                <a class="btn btn-primary" href="{{ route('serviceform.create') }}">Add new service</a>
              </div>
          ...
          <div class="col-md-6">
            <div class="form-group">
                ...
                <label for="input" class=" control-label">Select Service Name</label>
                  ...
                  <br>
                           <label href="/dashboard">show all
                    <input class="checkbox "type="checkbox"  value="/admin/serviceform" name="checket"
...
<p>Request citizen id : {{$serviccente->citizen_id}}</p>
<p>Request port number : {{$serviccente->port_number}}</p>
<p> Parallel request : {{$serviccente->parallel}}</p>
...
<form class="row" method="POST" action="{{ route('serviceform.destroy', ['id' => $serviccente->id]) }}" onsubmit = "return confirm('Are you sure?')">

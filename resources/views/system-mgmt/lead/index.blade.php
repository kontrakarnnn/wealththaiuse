...
@section('action-content')
  ...
  <div class="box-header">
    <div class="row">
        ...
        <div class="col-sm-4">
          <a class="btn btn-primary" href="{{ route('lead.create') }}">Add new lead</a>
        </div>
    </div>
  </div>
  <!-- /.box-header -->
  <div class="box-body">
      ...
      <form method="POST" action="{{ route('lead.searchnormal') }}">
         {{ csrf_field() }}
        ...
        <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
            ...
            <tr title="Meeting Date Missed"style="background-color:red; color:white"role="row" class="odd">
                  ...
                  <td><select style="color:black" class="  department nameid" name="regis_default_status" onchange="window.location.href=this.value;">
                      ...
                      <option value="/leadchangpriority/{{$l->id}}/1" >1</option>
                      <option value="/leadchangpriority/{{$l->id}}/2" >2</option>
                      <option value="/leadchangpriority/{{$l->id}}/3" >3</option>
                      <option value="/leadchangpriority/{{$l->id}}/4" >4</option>
                      <option value="/leadchangpriority/{{$l->id}}/5" >5</option>
                  </select></td>
                  ...
                  <td><select style="color:black" class=" department nameid" name="regis_default_status" onchange="window.location.href=this.value;">
                      ...
                      <option value="" ></option>
                      @foreach ($leadstatus as $sta)
                          <option value="/leadchangstatus/{{$l->id}}/{{$sta->id}}"{{$sta->id == $l->lead_status ? 'selected' : ''}}>{{$sta->name}}</option>
                      @endforeach

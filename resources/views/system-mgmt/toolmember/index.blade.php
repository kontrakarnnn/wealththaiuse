  ...
  <div class="box-header">
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        @foreach ($toolpackagemain as $type=> $serviccente)

                    @if($serviccente->attachment !=NULL)
                    <?php
                    $imageroot = '\toolpackage'.'\\'.$serviccente->attachment;
                    $image =public_path('toolpackage')."/".$serviccente->attachment;
                  ...
                  //echo '<img src="' . $src . '">';
                   ...
                   echo '<div class="item active"><a href="/toolmember/toolpackage/'.$serviccente->id.'"><img  src="'.$src.'" alt="{{$serviccente->name}}"  style="width:100%;"></a></div>';
                  ?>
                    @endif
                    @endforeach
        @foreach ($toolpackage as $type=> $serviccente)
                  ...
                  //echo '<img src="' . $src . '">';
                   ...
                   echo '<div class="item"><a href="/toolmember/toolpackage/'.$serviccente->id.'"><img  src="'.$src.'" alt="{{$serviccente->name}}"  style="width:100%;"></a></div>';
                  ?>
                    @endif
                    @endforeach
        ...
        <div id="carousel-example" class="carousel slide hidden-xs" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="item active">
                    <div class="row">
                      @foreach($toolpromote as $tp =>$serviccente)
                        <div class="col-sm-3">
                            <div class="col-item">
                                <div class="photo">
                                  @if($serviccente->attachment !=NULL)
                ...
                <div class="item">
                    <div class="row">
                      ...
                      @foreach($tooltophit as $tp =>$serviccente)
                        <div class="col-sm-3">
                            <div class="col-item">
                                <div class="photo">
                                  @if($serviccente->attachment !=NULL)

        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('view-member.update', ['id' => $view->id]) }}">
                        ...
                        <div class="form-group{{ $errors->has('belong_to') ? ' has-error' : '' }}">
                                                          <label class="col-md-4 control-label">belong_to</label>
                                                            <div class="col-md-6">
                                  <select class="form-control  name" name="belong_to">

            						  		<option></option>
                                            @foreach ($views as $vie)
            								  <option value="{{$vie->id}}" {{$vie->id == $view->belong_to ? 'selected' : ''}}>{{$vie->name}}</option>

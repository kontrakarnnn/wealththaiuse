    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">Add Member to Academic</div>
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('match-member-wealththai.store') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                              <select class="form-control" name="member_id"  id="nameid" required autofocus>
                                <option></option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                              <select class="form-control party" name="member_group_id" required autofocus >

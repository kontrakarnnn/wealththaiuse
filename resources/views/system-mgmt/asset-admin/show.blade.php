      ...
      <div class="row">
        <div class="col-sm-12">
          ...
          <div class="card-header"><h4>{{$porttype->name}} Asset Details</h4><div class="box-header">
            <div class="row">
                <div class="col-sm-8">
                  ...
                  <a class="btn btn-default" href="{{ URL::to('SecurityBroke/asset-transaction/show',[$porttype->id])}}">Asset Transaction</a>
          ...
          <div class="card-body">
            ...
            <tr>
              <th width="50%"><p>Referal Name</p></th>
            ...
            <tr>
              <th width="50%"><p>Referal Number1</p></th>
              <td >{{$porttype->ref_number1}} </td>

            </tr>

            <tr>
              <th width="50%"><p>Referal Number2</p></th>
              <td >{{$porttype->ref_number2}} </td>

            </tr>

            <tr>
              <th width="50%"><p>Referal Number3</p></th>
            ...
            <tr>
              <th width="50%"><p>File {{++$key}}</p></th>
                ...
                <td >  <a style="font-size:16px" href="{{ URL::to('SecurityBroke/showfile',[$a->id])}}" >{{$a->file_public_name}}</a>
                  ...
                  <br />
                  <form  role="form" method="POST" action="{{ URL::to('SecurityBroke/file/fakedelete',[$a->id])}}" onsubmit = "return confirm('Are you sure?')">
                      <input type="hidden" name="_method" value="PATCH">
                      <input type="hidden" name="_token" value="{{ csrf_token() }}">
<a class ="btn btn-warning"href="{{ URL::to('SecurityBroke/asset/editfile',[$a->id])}}">Edit File</a>

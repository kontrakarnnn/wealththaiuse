    ...
    <div id="example2_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
      <div class="row">
        <div class="col-sm-12">
          ...
          <div class="card-header"><h4>{{$porttype->name}} Asset Details</h4></div>
          <div class="card-body">
            ...
            <tr>
              <th width="50%"><p>Referal info1</p></th>
              <td >{{$porttype->ref_info1}} </td>

            </tr>

            <tr>
              <th width="50%"><p>Referal info2</p></th>
              <td >{{$porttype->ref_info2}} </td>

            </tr>

            <tr>
              <th width="50%"><p>Referal info3</p></th>
              <td >{{$porttype->ref_info3}} </td>

            </tr>

            <tr>
              <th width="50%"><p>Referal info4</p></th>
              <td >{{$porttype->ref_info4}} </td>

            </tr>

            <tr>
              <th width="50%"><p>Referal info5</p></th>
              <td >{{$porttype->ref_info5}} </td>

            </tr>

            <tr>
              <th width="50%"><p>Referal info6</p></th>
              <td >{{$porttype->ref_info6}} </td>

            </tr>

            <tr>
              <th width="50%"><p>Referal info7</p></th>
              <td >{{$porttype->ref_info7}} </td>

            </tr>

            <tr>
              <th width="50%"><p>Referal info8</p></th>

...
@section('action-content')
  ...
  <div class="box-body">
      ...
      <form method="POST" action="{{ route('asset-admin.search') }}">
         {{ csrf_field() }}
                ...
                <tr role="row" class="odd">
                  ...
                  <td>
                    <form class="row" method="POST" action="{{ route('asset-admin.destroy', ['id' => $port->id]) }}" onsubmit = "return confirm('Are you sure?')">
                        ...
                        <a href="{{ route('asset-admin.show', ['id' => $port->id]) }}" class="btn btn-info col-sm-3 col-xs-5 btn-margin">
                        Details
                        </a>
                        <a href="{{ route('asset-admin.edit', ['id' => $port->id]) }}" class="btn btn-warning col-sm-3 col-xs-5 btn-margin">
                        Update
                        </a>

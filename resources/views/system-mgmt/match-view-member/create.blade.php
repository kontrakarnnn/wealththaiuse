    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">Add View Authentication Member</div>
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('match-view-member.store') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            <label class="col-md-4 control-label">Member Group</label>
                            <div class="col-md-6">
                        ...
                        <div class="form-group">
                                          ...
                                          <div class="col-md-6">
                                    <input type="checkbox"  name="all_member" value="Yes"> All Member<br>
                                        </div>
                                        </div>

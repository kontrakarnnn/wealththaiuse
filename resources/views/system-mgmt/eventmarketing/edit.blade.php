        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('eventmarketing.update', ['id' => $event->id]) }}">
                      ...
                      <label class="col-md-4 control-label">Request Captcha</label>
                        ...
                        <div class="form-group{{ $errors->has('ticket_cost') ? ' has-error' : '' }}">
                            <label for="ticket_cost" class="col-md-4 control-label">Ticket Cost/Guest</label>

                            <div class="col-md-6">
                                <input id="ticket_cost" type="text" class="form-control" name="ticket_cost" value="{{ $event->ticket_cost }}" >

                                @if ($errors->has('ticket_cost'))
                                    <span class="help-event">
                                        <strong>{{ $errors->first('ticket_cost') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
                        <div class="form-group{{ $errors->has('redirect_link') ? ' has-error' : '' }}">
                            <label for="redirect_link" class="col-md-4 control-label">Redirect Link</label>

                            <div class="col-md-6">
                                <input id="redirect_link" type="text" class="form-control" name="redirect_link" value="{{ $event->redirect_link }}" >

                                @if ($errors->has('redirect_link'))
                                    <span class="help-event">
                                        <strong>{{ $errors->first('redirect_link') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                      <label class="col-md-4 control-label">Notification PublicID</label>
                        <div class="col-md-6">
                          <input class="form-control" list="browsers" name="noti_pid" value="{{$event->noti_pid}}">

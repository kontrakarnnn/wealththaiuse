        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('eventmarketing.store') }}">
                        {{ csrf_field() }}
                      ...
                      <label class="col-md-4 control-label">Request Captcha</label>
                        ...
                        <div class="form-group{{ $errors->has('ticket_cost') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input class="form-control" id="message-text" name="ticket_cost"/>
                        ...
                        <div class="form-group{{ $errors->has('redirect_link') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input class="form-control" id="message-text" name="redirect_link"/>
                      ...
                      <label class="col-md-4 control-label">Notification PublicID</label>
                        <div class="col-md-6">
                          <input class="form-control" list="browsers" name="noti_pid">

    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">Add User Authentication</div>
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('match-id.store') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('public_name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="public_name" type="text" class="form-control" name="public_name" value="{{ old('public_name') }}">
                        ...
                        <div class="form-group{{ $errors->has('public_email') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="public_email" type="text" class="form-control" name="public_email" value="{{ old('public_emai') }}">
                        ...
                        <div class="form-group{{ $errors->has('public_mobile') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="public_mobile" type="text" class="form-control" name="public_mobile" value="{{ old('public_mobile') }}">
                        ...
                        <div class="form-group{{ $errors->has('sender_citizen') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="sender_citizen" type="text" class="form-control" name="sender_citizen" value="{{ old('sender_citizen') }}">

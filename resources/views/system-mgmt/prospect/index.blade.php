...
@section('action-content')
  ...
  <div class="box-header">
    <div class="row">
        ...
        <div class="col-sm-4">
          @if($addprospect == 1)
          <a disabled class="btn btn-danger" href="#">your prospect more than limit !</a>
          @else
          <a  class="btn btn-primary" href="{{ route('prospect.create') }}">Add new prospect</a>
  ...
  <div class="box-body">
      ...
      <form method="POST" action="{{ route('prospect.searchnormal') }}">
         {{ csrf_field() }}
      ...
      <form method="POST" action="{{ route('prospect.search') }}">
         {{ csrf_field() }}
      ...
      <div class="row">
        ...
        <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
            ...
            <tbody>
              ...
              <form class="row" method="POST" action="{{ route('prospect.destroy', ['id' => $l->id]) }}" onsubmit = "return confirm('Are you sure?')">
              ...
              <!-- Modal content-->
              <form class="form-horizontal" role="form" method="POST" action="{{ route('prospect.update', ['id' =>  $l->id]) }}">
...
<div class="modal-footer" style="background-color:#00325d;color:white;">
  ...
  <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
        ...
        <tr title="Nearly Meeting Date"style="background-color:yellow; "role="row" class="odd">
...
<br />
@if(Auth::user()->limit_prospect == $prospectcount)
<p style="color:red"><b>Total Prospect {{$prospectcount}} Limit {{Auth::user()->limit_prospect}}</b> </p>
@else
<p><b>Prospect Limit {{Auth::user()->limit_prospect}} Used {{$prospectcount}}</b></p>
@endif
        <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
            <thead>
              <tr role="row">

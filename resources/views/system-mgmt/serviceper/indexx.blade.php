...
.card-header{
  ...
  <div class="box-body">
    ...
    {{--}}  <select class=" form-control department"   name="structure_id" onchange="this.value;" onkeyup='saveValue(this)' required>--}}
        <select class=" form-control department">
          <option disabled="true" selected="true">กลุ่มบริการ</option>
          @foreach (App\Group_service::all() as $cList)
              <option id"cat{{$cList->id}}"  value="{{$cList->id}}">{{$cList->name}}</option>
          @endforeach
        ...
        <div class="col-md-6">
          <div class="form-group">
                ...
                <select class=" form-control department"   name="structure_id" onchange="this.value;" onkeyup='saveValue(this)' required>
                    ...
                    <option disabled="true" selected="true">กลุ่มบริการ</option>
                    @foreach ($serg as $ser)
                        <option value="{{url('groupservice')}}/{{$ser->name}}" value="{{$ser->id}}">{{$ser->name}}</option>
                    @endforeach
              ...
              <label for="input" class=" control-label">Select Service Name</label>
                ...
                <br>
                <a href="/servicecenter" class="btn btn-info  ">
                  show all
                </a>
                ...
                success:function(data){
                 ...
                 console.log(data.length);
                  ...
                  for(var i=0; i<data.length;i++){
                    op+='<option value="{{url('service')}}/'+data[i].name+'">'+data[i].name+'</option>';

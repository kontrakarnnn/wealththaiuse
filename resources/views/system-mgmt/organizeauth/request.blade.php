            ...
            @foreach ($userauths as $userauth)
                <tr role="row" class="odd">
                  ...
                  <td >
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('organizeauth.updaterequest', ['id' => $userauth->id]) }}">
                    ...
                    <form  method="POST" action="organizeauth/delete/{{$userauth->id}}" onsubmit = "return confirm('Are you sure?')">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">

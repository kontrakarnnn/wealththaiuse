        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('match-partner-group.update', ['id' => $matchgroup->id]) }}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                              ...
                              <option value="{{$member->id}}" {{$member->id == $matchgroup->partner_id ? 'selected' : ''}}>{{$member->name}}</option>
                                @endforeach
                              </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                              <select class="form-control party" name="partner_group_id"  id="">
                                <option></option>
                                @foreach($ugroups as $ug)
                              <option value="{{$ug->id}}" {{$ug->id == $matchgroup->partner_group_id ? 'selected' : ''}}>{{$ug->name}}</option>
                                @endforeach
                              </select>
                            </div>
                        </div>

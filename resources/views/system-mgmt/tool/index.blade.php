          ...
          <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
            ...
            @foreach ($data as $da)
                <tr role="row" class="odd">
                  ...
                  <td>
                    <form class="row" method="POST" action="{{ route('tools.destroy', ['id' => $da->id]) }}" onsubmit = "return confirm('Are you sure?')">
                        ...
                        <a href="/tools/{{$da->id}}/toolset" class="btn btn-info btn-margin">
                        Tool Set
                        </a>
                        <a href="{{ route('tools.edit', ['id' => $da->id]) }}" class="btn btn-warning btn-margin">
                        Update
                        </a>

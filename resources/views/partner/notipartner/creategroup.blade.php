        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('messagecenter-partner.notigroup') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('sender_note') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="sender_note" type="text" class="form-control" name="sender_note" value="{{ old('sender_note') }}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                              <select class="form-control" name="gnum" >
                                <option></option>
                                @foreach($pidgroups as $pidgroup)
                                <option value="{{$pidgroup->id}}">{{$pidgroup->name}}</option>
                                @endforeach
                              </select>
                            </div>
                        </div>
                        {{--}}<div class="form-group{{ $errors->has('gnum') ? ' has-error' : '' }}">
                            <label for="gnum" class="col-md-4 control-label">gnum</label>

                            <div class="col-md-6">
                                <input id="gnum" type="text" class="form-control" name="gnum" value="{{ old('gnum') }}">

                                @if ($errors->has('gnum'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('gnum') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>--}}

        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('messagecenter-partner.store') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('recieve_id') ? ' has-error' : '' }}">
                            <label for="sender_id" class="col-md-4 control-label">recieve_id</label>

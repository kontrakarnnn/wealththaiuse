...
@section('action-content')
  ...
  <div class="box-header">
    <div class="row">
        ...
        <div class="col-sm-4">
        <a  href="{{ route('messagecenter-partner.create') }}">  <i style="font-size:200%"class="fa fa-user" title="Sent Message"></i>	</a>
          <a  href="{{ route('messagecenter-partner.creategroup') }}"><i style="color:red;margin-left:5%;font-size:200%"class="fa fa-users" title="Sent to Groups"></i></a>
  ...
  <div class="box-body">
      ...
      <form method="POST" action="{{ route('messagecenter-partner.search') }}">
         {{ csrf_field() }}
    ...
    <div id="example2_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
     ...
     @endforeach
			<a class="btn btn-default" href="{{ URL::to('/wealththaipartner/messagecenter-partner-sentbox')}}">
                          SentBox
                        </a>
			<a class="btn btn-default" href="{{ URL::to('/wealththaipartner/messagecenter-partner-inbox')}}">
                          InBox
                        </a>

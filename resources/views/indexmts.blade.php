...
@section('action-content')
  ...
  <div class="box-header">
    <div class="row">
        <div class="col-sm-4">
          <h3 class="box-title">MTS Document</h3>
        </div>
        <div class="col-sm-4" >
            <form class="form-horizontal" role="form" method="POST" action="{{ route('memmts.excel') }}" target = "_blank">
                {{ csrf_field() }}
        ...
        <div class="col-sm-4">
          ...
          <form class="form-horizontal" role="form" method="POST" action="{{ route('permts.pdf') }} " target = "_blank" >
              {{ csrf_field() }}
              <input type="hidden" value="{{$searchingVals['id_num']}}" name="id_num" />
  ...
  <div class="box-body">
      ...
      <form method="POST" action="{{ route('memmts.search') }}">
         {{ csrf_field() }}
